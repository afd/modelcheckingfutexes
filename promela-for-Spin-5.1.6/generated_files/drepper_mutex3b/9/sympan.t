...
{	Trans *T;
	...
	trans[2][2]	= /* c */ settr(112,2,3,3,3,"(run Thread())", 0, 2, 0);
	trans[2][3]	= /* c */ settr(113,2,4,3,3,"(run Thread())", 0, 2, 0);
	trans[2][4]	= /* c */ settr(114,2,5,3,3,"(run Thread())", 0, 2, 0);
	trans[2][5]	= /* c */ settr(115,2,6,3,3,"(run Thread())", 0, 2, 0);
	trans[2][6]	= /* c */ settr(116,2,7,3,3,"(run Thread())", 0, 2, 0);
	trans[2][7]	= /* c */ settr(117,2,8,3,3,"(run Thread())", 0, 2, 0);
	trans[2][8]	= /* c */ settr(118,2,9,3,3,"(run Thread())", 0, 2, 0);
	trans[2][9]	= /* c */ settr(119,2,10,3,3,"(run Thread())", 0, 2, 0);
	trans[2][10]	= settr(120,0,12,4,4,"(run Monitor())", 0, 2, 0);
	trans[2][12]	= settr(122,0,0,5,5,"-end-", 0, 3500, 0);
	...
	trans[1][1]	= settr(107,4,4,6,6,"((num_threads_in_cs>1))", 1, 2, 0); /* m: 2 -> 4,0 */
	reached1[2] = 1;
	trans[1][2]	= settr(0,0,0,0,0,"assert(0)",0,0,0);
	trans[1][4]	= settr(110,0,0,7,7,"-end-", 0, 3500, 0);
...
/*->*/	trans[0][61]	= settr(60,32,95,23,23,"D_STEP", 0, 2, 0);
	...
	trans[0][62]	= settr(61,2,89,24,24,"assert(!(futex.wait[_pid]))", 1, 2, 0); /* m: 63 -> 0,89 */
	reached0[63] = 1;
	...
	trans[0][64]	= settr(63,0,104,25,25,"(((num_woken==1)||(futex.num_waiting==0)))", 1, 2, 0); /* m: 92 -> 104,0 */
	reached0[92] = 1;
	...
	trans[0][67]	= settr(66,2,89,26,26,"(futex.wait[1])", 1, 2, 0); /* m: 68 -> 89,0 */
	reached0[68] = 1;
	trans[0][68]	= settr(0,0,0,0,0,"futex.wait[1] = 0",0,0,0);
	trans[0][86]	= settr(85,2,87,1,0,".(goto)", 1, 2, 0); /* m: 87 -> 0,89 */
	reached0[87] = 1;
	trans[0][69]	= settr(68,2,89,27,27,"(futex.wait[2])", 1, 2, 0); /* m: 70 -> 89,0 */
	reached0[70] = 1;
	trans[0][70]	= settr(0,0,0,0,0,"futex.wait[2] = 0",0,0,0);
	trans[0][71]	= settr(70,2,89,28,28,"(futex.wait[3])", 1, 2, 0); /* m: 72 -> 89,0 */
	reached0[72] = 1;
	trans[0][72]	= settr(0,0,0,0,0,"futex.wait[3] = 0",0,0,0);
	trans[0][73]	= settr(72,2,89,29,29,"(futex.wait[4])", 1, 2, 0); /* m: 74 -> 89,0 */
	reached0[74] = 1;
	trans[0][74]	= settr(0,0,0,0,0,"futex.wait[4] = 0",0,0,0);
	trans[0][75]	= settr(74,2,89,30,30,"(futex.wait[5])", 1, 2, 0); /* m: 76 -> 89,0 */
	reached0[76] = 1;
	trans[0][76]	= settr(0,0,0,0,0,"futex.wait[5] = 0",0,0,0);
	trans[0][77]	= settr(76,2,89,31,31,"(futex.wait[6])", 1, 2, 0); /* m: 78 -> 89,0 */
	reached0[78] = 1;
	trans[0][78]	= settr(0,0,0,0,0,"futex.wait[6] = 0",0,0,0);
	trans[0][79]	= settr(78,2,89,32,32,"(futex.wait[7])", 1, 2, 0); /* m: 80 -> 89,0 */
	reached0[80] = 1;
	trans[0][80]	= settr(0,0,0,0,0,"futex.wait[7] = 0",0,0,0);
	trans[0][81]	= settr(80,2,89,33,33,"(futex.wait[8])", 1, 2, 0); /* m: 82 -> 89,0 */
	reached0[82] = 1;
	trans[0][82]	= settr(0,0,0,0,0,"futex.wait[8] = 0",0,0,0);
	trans[0][83]	= settr(82,2,89,34,34,"(futex.wait[9])", 1, 2, 0); /* m: 84 -> 89,0 */
	reached0[84] = 1;
	trans[0][84]	= settr(0,0,0,0,0,"futex.wait[9] = 0",0,0,0);
	trans[0][87]	= settr(86,2,89,35,35,"futex.num_waiting = (futex.num_waiting-1)", 1, 2, 0); /* m: 88 -> 0,89 */
	reached0[88] = 1;
	trans[0][88]	= settr(0,0,0,0,0,"num_woken = (num_woken+1)",0,0,0);
	trans[0][91]	= settr(90,2,92,1,0,"break", 1, 2, 0);
	trans[0][92]	= settr(91,0,104,36,36,"printf('T%d woke up %d thread(s)\\n',_pid,num_woken)", 1, 2, 0); /* m: 93 -> 0,104 */
	reached0[93] = 1;
	trans[0][93]	= settr(0,0,0,0,0,"num_woken = 0",0,0,0);
	trans[0][100]	= settr(99,0,104,1,0,".(goto)", 0, 2, 0);
/*->*/	trans[0][98]	= settr(97,32,104,37,37,"D_STEP", 0, 2, 0);
