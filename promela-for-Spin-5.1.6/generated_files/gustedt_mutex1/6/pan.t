...
{	Trans *T;
	...
	trans[2][7]	= settr(125,0,9,4,4,"(run Monitor())", 0, 2, 0);
	trans[2][9]	= settr(127,0,0,5,5,"-end-", 0, 3500, 0);
...
/*->*/	trans[0][75]	= settr(74,32,106,26,26,"D_STEP", 1, 2, 0);
	...
	trans[0][77]	= settr(76,2,98,28,28,"assert(!(futex.wait[_pid]))", 1, 2, 0); /* m: 78 -> 0,98 */
	reached0[78] = 1;
	...
	trans[0][79]	= settr(78,0,112,29,29,"(((num_woken==1)||(futex.num_waiting==0)))", 1, 2, 0); /* m: 101 -> 112,0 */
	reached0[101] = 1;
	...
	trans[0][82]	= settr(81,2,98,30,30,"(futex.wait[1])", 1, 2, 0); /* m: 83 -> 98,0 */
	reached0[83] = 1;
	trans[0][83]	= settr(0,0,0,0,0,"futex.wait[1] = 0",0,0,0);
	trans[0][95]	= settr(94,2,96,1,0,".(goto)", 1, 2, 0); /* m: 96 -> 0,98 */
	reached0[96] = 1;
	trans[0][84]	= settr(83,2,98,31,31,"(futex.wait[2])", 1, 2, 0); /* m: 85 -> 98,0 */
	reached0[85] = 1;
	trans[0][85]	= settr(0,0,0,0,0,"futex.wait[2] = 0",0,0,0);
	trans[0][86]	= settr(85,2,98,32,32,"(futex.wait[3])", 1, 2, 0); /* m: 87 -> 98,0 */
	reached0[87] = 1;
	trans[0][87]	= settr(0,0,0,0,0,"futex.wait[3] = 0",0,0,0);
	trans[0][88]	= settr(87,2,98,33,33,"(futex.wait[4])", 1, 2, 0); /* m: 89 -> 98,0 */
	reached0[89] = 1;
	trans[0][89]	= settr(0,0,0,0,0,"futex.wait[4] = 0",0,0,0);
	trans[0][90]	= settr(89,2,98,34,34,"(futex.wait[5])", 1, 2, 0); /* m: 91 -> 98,0 */
	reached0[91] = 1;
	trans[0][91]	= settr(0,0,0,0,0,"futex.wait[5] = 0",0,0,0);
	trans[0][92]	= settr(91,2,98,35,35,"(futex.wait[6])", 1, 2, 0); /* m: 93 -> 98,0 */
	reached0[93] = 1;
	trans[0][93]	= settr(0,0,0,0,0,"futex.wait[6] = 0",0,0,0);
	trans[0][96]	= settr(95,2,98,36,36,"futex.num_waiting = (futex.num_waiting-1)", 1, 2, 0); /* m: 97 -> 0,98 */
	reached0[97] = 1;
	trans[0][97]	= settr(0,0,0,0,0,"num_woken = (num_woken+1)",0,0,0);
	trans[0][100]	= settr(99,2,101,1,0,"break", 1, 2, 0);
	trans[0][101]	= settr(100,0,112,37,37,"printf('T%d woke up %d thread(s)\\n',_pid,num_woken)", 1, 2, 0); /* m: 102 -> 0,112 */
	reached0[102] = 1;
	...
	trans[0][108]	= settr(107,0,112,38,38,"prev = 0", 0, 2, 0);
	trans[0][110]	= settr(109,0,115,39,0,"printf('T%d is done\\n',_pid)", 0, 2, 0);
	trans[0][111]	= settr(110,0,115,1,0,"goto :b0", 0, 2, 0);
	trans[0][114]	= settr(113,0,115,1,0,"break", 0, 2, 0);
	trans[0][115]	= settr(114,0,0,40,40,"-end-", 0, 3500, 0);
	/* np_ demon: */
