...
{	Trans *T;
	...
	trans[2][4]	= settr(116,0,6,4,4,"(run Monitor())", 0, 2, 0);
	trans[2][6]	= settr(118,0,0,5,5,"-end-", 0, 3500, 0);
...
/*->*/	trans[0][75]	= settr(74,32,100,26,26,"D_STEP", 1, 2, 0);
	...
	trans[0][77]	= settr(76,2,92,28,28,"assert(!(futex.wait[_pid]))", 1, 2, 0); /* m: 78 -> 0,92 */
	reached0[78] = 1;
	...
	trans[0][79]	= settr(78,0,106,29,29,"(((num_woken==1)||(futex.num_waiting==0)))", 1, 2, 0); /* m: 95 -> 106,0 */
	reached0[95] = 1;
	...
	trans[0][82]	= settr(81,2,92,30,30,"(futex.wait[1])", 1, 2, 0); /* m: 83 -> 92,0 */
	reached0[83] = 1;
	trans[0][83]	= settr(0,0,0,0,0,"futex.wait[1] = 0",0,0,0);
	trans[0][89]	= settr(88,2,90,1,0,".(goto)", 1, 2, 0); /* m: 90 -> 0,92 */
	reached0[90] = 1;
	trans[0][84]	= settr(83,2,92,31,31,"(futex.wait[2])", 1, 2, 0); /* m: 85 -> 92,0 */
	reached0[85] = 1;
	trans[0][85]	= settr(0,0,0,0,0,"futex.wait[2] = 0",0,0,0);
	trans[0][86]	= settr(85,2,92,32,32,"(futex.wait[3])", 1, 2, 0); /* m: 87 -> 92,0 */
	reached0[87] = 1;
	trans[0][87]	= settr(0,0,0,0,0,"futex.wait[3] = 0",0,0,0);
	trans[0][90]	= settr(89,2,92,33,33,"futex.num_waiting = (futex.num_waiting-1)", 1, 2, 0); /* m: 91 -> 0,92 */
	reached0[91] = 1;
	trans[0][91]	= settr(0,0,0,0,0,"num_woken = (num_woken+1)",0,0,0);
	trans[0][94]	= settr(93,2,95,1,0,"break", 1, 2, 0);
	trans[0][95]	= settr(94,0,106,34,34,"printf('T%d woke up %d thread(s)\\n',_pid,num_woken)", 1, 2, 0); /* m: 96 -> 0,106 */
	reached0[96] = 1;
	...
	trans[0][102]	= settr(101,0,106,35,35,"prev = 0", 0, 2, 0);
	trans[0][104]	= settr(103,0,109,36,0,"printf('T%d is done\\n',_pid)", 0, 2, 0);
	trans[0][105]	= settr(104,0,109,1,0,"goto :b0", 0, 2, 0);
	trans[0][108]	= settr(107,0,109,1,0,"break", 0, 2, 0);
	trans[0][109]	= settr(108,0,0,37,37,"-end-", 0, 3500, 0);
	/* np_ demon: */
