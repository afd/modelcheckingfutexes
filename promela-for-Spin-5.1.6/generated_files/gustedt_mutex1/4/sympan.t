...
{	Trans *T;
	...
	trans[2][5]	= settr(119,0,7,4,4,"(run Monitor())", 0, 2, 0);
	trans[2][7]	= settr(121,0,0,5,5,"-end-", 0, 3500, 0);
...
/*->*/	trans[0][75]	= settr(74,32,102,26,26,"D_STEP", 1, 2, 0);
	...
	trans[0][77]	= settr(76,2,94,28,28,"assert(!(futex.wait[_pid]))", 1, 2, 0); /* m: 78 -> 0,94 */
	reached0[78] = 1;
	...
	trans[0][79]	= settr(78,0,108,29,29,"(((num_woken==1)||(futex.num_waiting==0)))", 1, 2, 0); /* m: 97 -> 108,0 */
	reached0[97] = 1;
	...
	trans[0][82]	= settr(81,2,94,30,30,"(futex.wait[1])", 1, 2, 0); /* m: 83 -> 94,0 */
	reached0[83] = 1;
	trans[0][83]	= settr(0,0,0,0,0,"futex.wait[1] = 0",0,0,0);
	trans[0][91]	= settr(90,2,92,1,0,".(goto)", 1, 2, 0); /* m: 92 -> 0,94 */
	reached0[92] = 1;
	trans[0][84]	= settr(83,2,94,31,31,"(futex.wait[2])", 1, 2, 0); /* m: 85 -> 94,0 */
	reached0[85] = 1;
	trans[0][85]	= settr(0,0,0,0,0,"futex.wait[2] = 0",0,0,0);
	trans[0][86]	= settr(85,2,94,32,32,"(futex.wait[3])", 1, 2, 0); /* m: 87 -> 94,0 */
	reached0[87] = 1;
	trans[0][87]	= settr(0,0,0,0,0,"futex.wait[3] = 0",0,0,0);
	trans[0][88]	= settr(87,2,94,33,33,"(futex.wait[4])", 1, 2, 0); /* m: 89 -> 94,0 */
	reached0[89] = 1;
	trans[0][89]	= settr(0,0,0,0,0,"futex.wait[4] = 0",0,0,0);
	trans[0][92]	= settr(91,2,94,34,34,"futex.num_waiting = (futex.num_waiting-1)", 1, 2, 0); /* m: 93 -> 0,94 */
	reached0[93] = 1;
	trans[0][93]	= settr(0,0,0,0,0,"num_woken = (num_woken+1)",0,0,0);
	trans[0][96]	= settr(95,2,97,1,0,"break", 1, 2, 0);
	trans[0][97]	= settr(96,0,108,35,35,"printf('T%d woke up %d thread(s)\\n',_pid,num_woken)", 1, 2, 0); /* m: 98 -> 0,108 */
	reached0[98] = 1;
	...
	trans[0][104]	= settr(103,0,108,36,36,"prev = 0", 0, 2, 0);
	trans[0][106]	= settr(105,0,111,37,0,"printf('T%d is done\\n',_pid)", 0, 2, 0);
	trans[0][107]	= settr(106,0,111,1,0,"goto :b0", 0, 2, 0);
	trans[0][110]	= settr(109,0,111,1,0,"break", 0, 2, 0);
	trans[0][111]	= settr(110,0,0,38,38,"-end-", 0, 3500, 0);
	/* np_ demon: */
