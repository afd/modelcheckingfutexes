...
{	Trans *T;
	...
	trans[2][2]	= /* c */ settr(126,2,3,3,3,"(run Thread())", 0, 2, 0);
	trans[2][3]	= /* c */ settr(127,2,4,3,3,"(run Thread())", 0, 2, 0);
	trans[2][4]	= /* c */ settr(128,2,5,3,3,"(run Thread())", 0, 2, 0);
	trans[2][5]	= /* c */ settr(129,2,6,3,3,"(run Thread())", 0, 2, 0);
	trans[2][6]	= /* c */ settr(130,2,7,3,3,"(run Thread())", 0, 2, 0);
	trans[2][7]	= /* c */ settr(131,2,8,3,3,"(run Thread())", 0, 2, 0);
	trans[2][8]	= /* c */ settr(132,2,9,3,3,"(run Thread())", 0, 2, 0);
	trans[2][9]	= /* c */ settr(133,2,10,3,3,"(run Thread())", 0, 2, 0);
	trans[2][10]	= settr(134,0,12,4,4,"(run Monitor())", 0, 2, 0);
	trans[2][12]	= settr(136,0,0,5,5,"-end-", 0, 3500, 0);
	...
	trans[1][1]	= settr(121,4,4,6,6,"((num_threads_in_cs>1))", 1, 2, 0); /* m: 2 -> 4,0 */
	reached1[2] = 1;
	trans[1][2]	= settr(0,0,0,0,0,"assert(0)",0,0,0);
	trans[1][4]	= settr(124,0,0,7,7,"-end-", 0, 3500, 0);
...
/*->*/	trans[0][75]	= settr(74,32,112,26,26,"D_STEP", 1, 2, 0);
	...
	trans[0][77]	= settr(76,2,104,28,28,"assert(!(futex.wait[_pid]))", 1, 2, 0); /* m: 78 -> 0,104 */
	reached0[78] = 1;
	...
	trans[0][79]	= settr(78,0,118,29,29,"(((num_woken==1)||(futex.num_waiting==0)))", 1, 2, 0); /* m: 107 -> 118,0 */
	reached0[107] = 1;
	...
	trans[0][82]	= settr(81,2,104,30,30,"(futex.wait[1])", 1, 2, 0); /* m: 83 -> 104,0 */
	reached0[83] = 1;
	trans[0][83]	= settr(0,0,0,0,0,"futex.wait[1] = 0",0,0,0);
	trans[0][101]	= settr(100,2,102,1,0,".(goto)", 1, 2, 0); /* m: 102 -> 0,104 */
	reached0[102] = 1;
	trans[0][84]	= settr(83,2,104,31,31,"(futex.wait[2])", 1, 2, 0); /* m: 85 -> 104,0 */
	reached0[85] = 1;
	trans[0][85]	= settr(0,0,0,0,0,"futex.wait[2] = 0",0,0,0);
	trans[0][86]	= settr(85,2,104,32,32,"(futex.wait[3])", 1, 2, 0); /* m: 87 -> 104,0 */
	reached0[87] = 1;
	trans[0][87]	= settr(0,0,0,0,0,"futex.wait[3] = 0",0,0,0);
	trans[0][88]	= settr(87,2,104,33,33,"(futex.wait[4])", 1, 2, 0); /* m: 89 -> 104,0 */
	reached0[89] = 1;
	trans[0][89]	= settr(0,0,0,0,0,"futex.wait[4] = 0",0,0,0);
	trans[0][90]	= settr(89,2,104,34,34,"(futex.wait[5])", 1, 2, 0); /* m: 91 -> 104,0 */
	reached0[91] = 1;
	trans[0][91]	= settr(0,0,0,0,0,"futex.wait[5] = 0",0,0,0);
	trans[0][92]	= settr(91,2,104,35,35,"(futex.wait[6])", 1, 2, 0); /* m: 93 -> 104,0 */
	reached0[93] = 1;
	trans[0][93]	= settr(0,0,0,0,0,"futex.wait[6] = 0",0,0,0);
	trans[0][94]	= settr(93,2,104,36,36,"(futex.wait[7])", 1, 2, 0); /* m: 95 -> 104,0 */
	reached0[95] = 1;
	trans[0][95]	= settr(0,0,0,0,0,"futex.wait[7] = 0",0,0,0);
	trans[0][96]	= settr(95,2,104,37,37,"(futex.wait[8])", 1, 2, 0); /* m: 97 -> 104,0 */
	reached0[97] = 1;
	trans[0][97]	= settr(0,0,0,0,0,"futex.wait[8] = 0",0,0,0);
	trans[0][98]	= settr(97,2,104,38,38,"(futex.wait[9])", 1, 2, 0); /* m: 99 -> 104,0 */
	reached0[99] = 1;
	trans[0][99]	= settr(0,0,0,0,0,"futex.wait[9] = 0",0,0,0);
	trans[0][102]	= settr(101,2,104,39,39,"futex.num_waiting = (futex.num_waiting-1)", 1, 2, 0); /* m: 103 -> 0,104 */
	reached0[103] = 1;
	trans[0][103]	= settr(0,0,0,0,0,"num_woken = (num_woken+1)",0,0,0);
	trans[0][106]	= settr(105,2,107,1,0,"break", 1, 2, 0);
	trans[0][107]	= settr(106,0,118,40,40,"printf('T%d woke up %d thread(s)\\n',_pid,num_woken)", 1, 2, 0); /* m: 108 -> 0,118 */
	reached0[108] = 1;
	...
	trans[0][114]	= settr(113,0,118,41,41,"prev = 0", 0, 2, 0);
	trans[0][116]	= settr(115,0,121,42,0,"printf('T%d is done\\n',_pid)", 0, 2, 0);
	trans[0][117]	= settr(116,0,121,1,0,"goto :b0", 0, 2, 0);
	trans[0][120]	= settr(119,0,121,1,0,"break", 0, 2, 0);
	trans[0][121]	= settr(120,0,0,43,43,"-end-", 0, 3500, 0);
	/* np_ demon: */
