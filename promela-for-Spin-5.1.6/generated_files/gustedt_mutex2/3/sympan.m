...
/* STATE 3 - line 42 "../../../mutex_generic.pml" - [(run Thread())] (0:0 - 1) same as 3 (0:0 - 1) */
	case 4: /* STATE 4 - line 68 "../../../mutex_generic.pml" - [(run Monitor())] (0:0:0 - 1) */
		IfNotBlocked
		reached[2][4] = 1;
		if (!(addproc(1)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 5: /* STATE 6 - line 70 "../../../mutex_generic.pml" - [-end-] (0:0:0 - 1) */
		IfNotBlocked
		reached[2][6] = 1;
...
S_009_0: /* 1 */
	...
	case 12: /* STATE 16 - line 36 "../../../gustedt_mutex2.pml" - [(((1<<7)&cur))] (24:0:1 - 1) */
		...
		((P0 *)this)->cur = ( (((((1<<7)-1)&((int)((P0 *)this)->cur))==0)) ? ((3+1)) : (((((1<<7)-1)&((int)((P0 *)this)->cur))-1)) );
#ifdef VAR_RANGES
		logval("Thread:cur", ((int)((P0 *)this)->cur));
#endif
		;
...
S_046_0: /* 2 */
		assert( !(((int)now.futex.wait[ Index(((int)((P0 *)this)->_pid), 5) ])), " !(futex.wait[_pid])", II, tt, t);
S_047_0: /* 2 */
...
S_054_0: /* 2 */
	...
	case 22: /* STATE 60 - line 53 "../../../gustedt_mutex2.pml" - [cur = ( (((((1<<7)-1)&cur)==0)) -> ((3+1)) : (((((1<<7)-1)&cur)-1)) )] (0:67:1 - 3) */
		IfNotBlocked
		reached[0][60] = 1;
		(trpt+1)->bup.oval = ((int)((P0 *)this)->cur);
		((P0 *)this)->cur = ( (((((1<<7)-1)&((int)((P0 *)this)->cur))==0)) ? ((3+1)) : (((((1<<7)-1)&((int)((P0 *)this)->cur))-1)) );
...
S_112_0: /* 1 */
	...
	case 29: /* STATE 89 - line 73 "../../../gustedt_mutex2.pml" - [((prev_unlock!=((1<<7)|1)))] (0:0:1 - 1) */
		...
		_m = 3; goto P999; /* 0 */
	case 30: /* STATE 90 - line 70 "../../../futex.pml" - [assert(!(futex.wait[_pid]))] (0:105:1 - 1) */
		IfNotBlocked
		reached[0][90] = 1;
		assert( !(((int)now.futex.wait[ Index(((int)((P0 *)this)->_pid), 5) ])), " !(futex.wait[_pid])", II, tt, t);
		...
		;
		_m = 3; goto P999; /* 2 */
	case 31: /* STATE 92 - line 74 "../../../futex.pml" - [(((num_woken==1)||(futex.num_waiting==0)))] (119:0:2 - 1) */
		IfNotBlocked
		reached[0][92] = 1;
		...
		reached[0][114] = 1;
		;
		/* merge: prev_unlock = 0(119, 115, 119) */
		reached[0][115] = 1;
		...
		;
		_m = 3; goto P999; /* 6 */
	case 32: /* STATE 95 - line 78 "../../../futex.pml" - [(futex.wait[1])] (105:0:3 - 1) */
		IfNotBlocked
		reached[0][95] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 33: /* STATE 97 - line 80 "../../../futex.pml" - [(futex.wait[2])] (105:0:3 - 1) */
		IfNotBlocked
		reached[0][97] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 34: /* STATE 99 - line 83 "../../../futex.pml" - [(futex.wait[3])] (105:0:3 - 1) */
		IfNotBlocked
		reached[0][99] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 35: /* STATE 103 - line 85 "../../../futex.pml" - [futex.num_waiting = (futex.num_waiting-1)] (0:105:2 - 4) */
		IfNotBlocked
		reached[0][103] = 1;
		(trpt+1)->bup.ovals = grab_ints(2);
		...
		;
		_m = 3; goto P999; /* 2 */
	case 36: /* STATE 108 - line 88 "../../../futex.pml" - [printf('T%d woke up %d thread(s)\\n',_pid,num_woken)] (0:119:2 - 3) */
		IfNotBlocked
		reached[0][108] = 1;
		Printf("T%d woke up %d thread(s)\n", ((int)((P0 *)this)->_pid), ((int)((P0 *)this)->num_woken));
		/* merge: num_woken = 0(119, 109, 119) */
		...
		;
		_m = 3; goto P999; /* 4 */
	case 37: /* STATE 115 - line 76 "../../../gustedt_mutex2.pml" - [prev_unlock = 0] (0:119:1 - 3) */
		IfNotBlocked
		reached[0][115] = 1;
		...
		;
		_m = 3; goto P999; /* 1 */
	case 38: /* STATE 117 - line 22 "../../../mutex_generic.pml" - [printf('T%d is done\\n',_pid)] (0:0:0 - 1) */
		IfNotBlocked
		reached[0][117] = 1;
		Printf("T%d is done\n", ((int)((P0 *)this)->_pid));
		_m = 3; goto P999; /* 0 */
	case 39: /* STATE 122 - line 24 "../../../mutex_generic.pml" - [-end-] (0:0:0 - 3) */
		IfNotBlocked
		reached[0][122] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
