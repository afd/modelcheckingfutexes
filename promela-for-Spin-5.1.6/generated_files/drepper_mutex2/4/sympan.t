...
{	Trans *T;
	...
	trans[2][5]	= settr(115,0,7,4,4,"(run Monitor())", 0, 2, 0);
	trans[2][7]	= settr(117,0,0,5,5,"-end-", 0, 3500, 0);
...
/*->*/	trans[0][71]	= settr(70,32,95,28,28,"D_STEP", 1, 2, 0);
	...
	trans[0][72]	= settr(71,2,89,29,29,"assert(!(futex.wait[_pid]))", 1, 2, 0); /* m: 73 -> 0,89 */
	reached0[73] = 1;
	...
	trans[0][74]	= settr(73,0,104,30,30,"(((num_woken==1)||(futex.num_waiting==0)))", 1, 2, 0); /* m: 92 -> 104,0 */
	reached0[92] = 1;
	...
	trans[0][77]	= settr(76,2,89,31,31,"(futex.wait[1])", 1, 2, 0); /* m: 78 -> 89,0 */
	reached0[78] = 1;
	trans[0][78]	= settr(0,0,0,0,0,"futex.wait[1] = 0",0,0,0);
	trans[0][86]	= settr(85,2,87,1,0,".(goto)", 1, 2, 0); /* m: 87 -> 0,89 */
	reached0[87] = 1;
	trans[0][79]	= settr(78,2,89,32,32,"(futex.wait[2])", 1, 2, 0); /* m: 80 -> 89,0 */
	reached0[80] = 1;
	trans[0][80]	= settr(0,0,0,0,0,"futex.wait[2] = 0",0,0,0);
	trans[0][81]	= settr(80,2,89,33,33,"(futex.wait[3])", 1, 2, 0); /* m: 82 -> 89,0 */
	reached0[82] = 1;
	trans[0][82]	= settr(0,0,0,0,0,"futex.wait[3] = 0",0,0,0);
	trans[0][83]	= settr(82,2,89,34,34,"(futex.wait[4])", 1, 2, 0); /* m: 84 -> 89,0 */
	reached0[84] = 1;
