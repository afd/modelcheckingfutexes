...
{	Trans *T;
	...
	trans[2][3]	= settr(109,0,5,4,4,"(run Monitor())", 0, 2, 0);
	trans[2][5]	= settr(111,0,0,5,5,"-end-", 0, 3500, 0);
...
/*->*/	trans[0][71]	= settr(70,32,91,28,28,"D_STEP", 1, 2, 0);
	...
	trans[0][72]	= settr(71,2,85,29,29,"assert(!(futex.wait[_pid]))", 1, 2, 0); /* m: 73 -> 0,85 */
	reached0[73] = 1;
	...
	trans[0][74]	= settr(73,0,100,30,30,"(((num_woken==1)||(futex.num_waiting==0)))", 1, 2, 0); /* m: 88 -> 100,0 */
	reached0[88] = 1;
	...
	trans[0][77]	= settr(76,2,85,31,31,"(futex.wait[1])", 1, 2, 0); /* m: 78 -> 85,0 */
	reached0[78] = 1;
	trans[0][78]	= settr(0,0,0,0,0,"futex.wait[1] = 0",0,0,0);
	trans[0][82]	= settr(81,2,83,1,0,".(goto)", 1, 2, 0); /* m: 83 -> 0,85 */
	reached0[83] = 1;
	trans[0][79]	= settr(78,2,85,32,32,"(futex.wait[2])", 1, 2, 0); /* m: 80 -> 85,0 */
	reached0[80] = 1;
