...
{	Trans *T;
	...
	trans[2][4]	= settr(112,0,6,4,4,"(run Monitor())", 0, 2, 0);
	trans[2][6]	= settr(114,0,0,5,5,"-end-", 0, 3500, 0);
...
/*->*/	trans[0][71]	= settr(70,32,93,28,28,"D_STEP", 1, 2, 0);
	...
	trans[0][72]	= settr(71,2,87,29,29,"assert(!(futex.wait[_pid]))", 1, 2, 0); /* m: 73 -> 0,87 */
	reached0[73] = 1;
	...
	trans[0][74]	= settr(73,0,102,30,30,"(((num_woken==1)||(futex.num_waiting==0)))", 1, 2, 0); /* m: 90 -> 102,0 */
	reached0[90] = 1;
	...
	trans[0][77]	= settr(76,2,87,31,31,"(futex.wait[1])", 1, 2, 0); /* m: 78 -> 87,0 */
	reached0[78] = 1;
	trans[0][78]	= settr(0,0,0,0,0,"futex.wait[1] = 0",0,0,0);
	trans[0][84]	= settr(83,2,85,1,0,".(goto)", 1, 2, 0); /* m: 85 -> 0,87 */
	reached0[85] = 1;
	trans[0][79]	= settr(78,2,87,32,32,"(futex.wait[2])", 1, 2, 0); /* m: 80 -> 87,0 */
	reached0[80] = 1;
	trans[0][80]	= settr(0,0,0,0,0,"futex.wait[2] = 0",0,0,0);
	trans[0][81]	= settr(80,2,87,33,33,"(futex.wait[3])", 1, 2, 0); /* m: 82 -> 87,0 */
	reached0[82] = 1;
