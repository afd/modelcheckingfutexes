...
{	Trans *T;
	...
	trans[2][2]	= /* c */ settr(103,2,3,3,3,"(run Thread())", 0, 2, 0);
	trans[2][3]	= /* c */ settr(104,2,4,3,3,"(run Thread())", 0, 2, 0);
	trans[2][4]	= /* c */ settr(105,2,5,3,3,"(run Thread())", 0, 2, 0);
	trans[2][5]	= settr(106,0,7,4,4,"(run Monitor())", 0, 2, 0);
	trans[2][7]	= settr(108,0,0,5,5,"-end-", 0, 3500, 0);
	...
	trans[1][1]	= settr(98,4,4,6,6,"((num_threads_in_cs>1))", 1, 2, 0); /* m: 2 -> 4,0 */
	reached1[2] = 1;
	trans[1][2]	= settr(0,0,0,0,0,"assert(0)",0,0,0);
	trans[1][4]	= settr(101,0,0,7,7,"-end-", 0, 3500, 0);
...
/*->*/	trans[0][62]	= settr(61,32,86,23,23,"D_STEP", 1, 2, 0);
	...
	trans[0][63]	= settr(62,2,80,24,24,"assert(!(futex.wait[_pid]))", 1, 2, 0); /* m: 64 -> 0,80 */
	reached0[64] = 1;
	...
	trans[0][65]	= settr(64,0,95,25,25,"(((num_woken==1)||(futex.num_waiting==0)))", 1, 2, 0); /* m: 83 -> 95,0 */
	reached0[83] = 1;
