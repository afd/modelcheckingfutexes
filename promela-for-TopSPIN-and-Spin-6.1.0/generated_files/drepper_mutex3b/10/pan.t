...
{	Trans *T;
	...
	T = T->nxt	= settr(105,0,50,0,0,"DO", 0, 2, 0);
...
/*->*/	trans[0][61]	= settr(60,32,97,32,32,"D_STEP", 0, 2, 0);
	...
	reached0[94] = 1;
	trans[0][66]	= settr(65,2,87,2,0,"else", 1, 2, 0);
	T = trans[0][87] = settr(86,2,0,0,0,"IF", 1, 2, 0);
	T = T->nxt	= settr(86,2,67,0,0,"IF", 1, 2, 0);
	T = T->nxt	= settr(86,2,69,0,0,"IF", 1, 2, 0);
	T = T->nxt	= settr(86,2,71,0,0,"IF", 1, 2, 0);
	T = T->nxt	= settr(86,2,73,0,0,"IF", 1, 2, 0);
	T = T->nxt	= settr(86,2,75,0,0,"IF", 1, 2, 0);
