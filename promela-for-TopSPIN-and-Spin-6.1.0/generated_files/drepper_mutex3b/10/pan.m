...
S_042_0: /* 1 */
	...
	case 30: /* STATE 52 - ../../../mutex_generic.pml:27 - [num_threads_in_cs = (num_threads_in_cs-1)] (0:0:1 - 1) */
		...
		;
		_m = 3; goto P999; /* 0 */
	case 31: /* STATE 58 - ../../../drepper_mutex3b.pml:19 - [D_STEP] */
		IfNotBlocked
		sv_save();
		reached[0][58] = 1;
		reached[0][t->st] = 1;
...
S_100_0: /* 1 */
	...
	case 32: /* STATE 61 - ../../../drepper_mutex3b.pml:24 - [D_STEP] */
...
S_096_0: /* 1 */
	...
	case 33: /* STATE 62 - ../../../futex.pml:70 - [assert(!(futex.wait[_pid]))] (0:91:1 - 1) */
		IfNotBlocked
		reached[0][62] = 1;
		spin_assert( !(((int)now.futex.wait[ Index(((int)((P0 *)this)->_pid), 12) ])), " !(futex.wait[_pid])", II, tt, t);
		...
		;
		_m = 3; goto P999; /* 2 */
	case 34: /* STATE 64 - ../../../futex.pml:74 - [(((num_woken==1)||(futex.num_waiting==0)))] (106:0:1 - 1) */
		IfNotBlocked
		reached[0][64] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 35: /* STATE 67 - ../../../futex.pml:78 - [(futex.wait[1])] (91:0:3 - 1) */
		IfNotBlocked
		reached[0][67] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 36: /* STATE 69 - ../../../futex.pml:80 - [(futex.wait[2])] (91:0:3 - 1) */
		IfNotBlocked
		reached[0][69] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 37: /* STATE 71 - ../../../futex.pml:83 - [(futex.wait[3])] (91:0:3 - 1) */
		IfNotBlocked
		reached[0][71] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 38: /* STATE 73 - ../../../futex.pml:87 - [(futex.wait[4])] (91:0:3 - 1) */
		IfNotBlocked
		reached[0][73] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 39: /* STATE 75 - ../../../futex.pml:91 - [(futex.wait[5])] (91:0:3 - 1) */
		IfNotBlocked
		reached[0][75] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 40: /* STATE 77 - ../../../futex.pml:95 - [(futex.wait[6])] (91:0:3 - 1) */
		IfNotBlocked
		reached[0][77] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 41: /* STATE 79 - ../../../futex.pml:99 - [(futex.wait[7])] (91:0:3 - 1) */
		IfNotBlocked
		reached[0][79] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 42: /* STATE 81 - ../../../futex.pml:103 - [(futex.wait[8])] (91:0:3 - 1) */
		IfNotBlocked
		reached[0][81] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 43: /* STATE 83 - ../../../futex.pml:107 - [(futex.wait[9])] (91:0:3 - 1) */
		IfNotBlocked
		reached[0][83] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 44: /* STATE 85 - ../../../futex.pml:111 - [(futex.wait[10])] (91:0:3 - 1) */
		IfNotBlocked
		reached[0][85] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 45: /* STATE 89 - ../../../futex.pml:118 - [futex.num_waiting = (futex.num_waiting-1)] (0:91:2 - 11) */
		IfNotBlocked
		reached[0][89] = 1;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 46: /* STATE 94 - ../../../futex.pml:121 - [printf('T%d woke up %d thread(s)\\n',_pid,num_woken)] (0:106:1 - 3) */
		IfNotBlocked
		reached[0][94] = 1;
		Printf("T%d woke up %d thread(s)\n", ((int)((P0 *)this)->_pid), ((int)((P0 *)this)->_2_num_woken));
		/* merge: num_woken = 0(106, 95, 106) */
		...
		;
		_m = 3; goto P999; /* 3 */
	case 47: /* STATE 100 - ../../../drepper_mutex3b.pml:26 - [D_STEP] */
...
S_101_0: /* 1 */
	...
	case 48: /* STATE 104 - ../../../mutex_generic.pml:29 - [printf('T%d is done\\n',_pid)] (0:0:0 - 1) */
		IfNotBlocked
		reached[0][104] = 1;
		Printf("T%d is done\n", ((int)((P0 *)this)->_pid));
		_m = 3; goto P999; /* 0 */
	case 49: /* STATE 109 - ../../../mutex_generic.pml:31 - [-end-] (0:0:0 - 3) */
		IfNotBlocked
		reached[0][109] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
