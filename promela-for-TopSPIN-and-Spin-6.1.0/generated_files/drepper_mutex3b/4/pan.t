...
{	Trans *T;
	...
	trans[2][2]	= /* c */ settr(102,2,3,3,3,"(run Thread())", 0, 2, 0);
	trans[2][3]	= /* c */ settr(103,2,4,3,3,"(run Thread())", 0, 2, 0);
	trans[2][4]	= /* c */ settr(104,2,5,3,3,"(run Thread())", 0, 2, 0);
	trans[2][5]	= settr(105,0,7,4,4,"(run Monitor())", 0, 2, 0);
	trans[2][7]	= settr(107,0,0,5,5,"-end-", 0, 3500, 0);
	...
	trans[1][1]	= settr(97,4,4,6,6,"((num_threads_in_cs>1))", 1, 2, 0); /* m: 2 -> 4,0 */
	reached1[2] = 1;
	trans[1][2]	= settr(0,0,0,0,0,"assert(0)",0,0,0);
	trans[1][4]	= settr(100,0,0,7,7,"-end-", 0, 3500, 0);
...
/*->*/	trans[0][61]	= settr(60,32,85,23,23,"D_STEP", 0, 2, 0);
	...
	trans[0][62]	= settr(61,2,79,24,24,"assert(!(futex.wait[_pid]))", 1, 2, 0); /* m: 63 -> 0,79 */
	reached0[63] = 1;
	...
	trans[0][64]	= settr(63,0,94,25,25,"(((num_woken==1)||(futex.num_waiting==0)))", 1, 2, 0); /* m: 82 -> 94,0 */
	reached0[82] = 1;
