...
S_042_0: /* 1 */
	...
	case 24: /* STATE 52 - ../../../mutex_generic.pml:27 - [num_threads_in_cs = (num_threads_in_cs-1)] (0:0:1 - 1) */
		...
		;
		_m = 3; goto P999; /* 0 */
	case 25: /* STATE 58 - ../../../drepper_mutex3b.pml:19 - [D_STEP] */
		IfNotBlocked
		sv_save();
		reached[0][58] = 1;
		reached[0][t->st] = 1;
...
S_088_0: /* 1 */
	...
	case 26: /* STATE 61 - ../../../drepper_mutex3b.pml:24 - [D_STEP] */
...
S_084_0: /* 1 */
	...
	case 27: /* STATE 62 - ../../../futex.pml:70 - [assert(!(futex.wait[_pid]))] (0:79:1 - 1) */
		IfNotBlocked
		reached[0][62] = 1;
		spin_assert( !(((int)now.futex.wait[ Index(((int)((P0 *)this)->_pid), 6) ])), " !(futex.wait[_pid])", II, tt, t);
		/* merge: num_woken = 0(79, 63, 79) */
		reached[0][63] = 1;
	...
	case 28: /* STATE 64 - ../../../futex.pml:74 - [(((num_woken==1)||(futex.num_waiting==0)))] (94:0:1 - 1) */
		...
		;
		_m = 3; goto P999; /* 5 */
	case 29: /* STATE 67 - ../../../futex.pml:78 - [(futex.wait[1])] (79:0:3 - 1) */
		IfNotBlocked
		reached[0][67] = 1;
		if (!(((int)now.futex.wait[1])))
			continue;
		/* merge: futex.wait[1] = 0(79, 68, 79) */
		reached[0][68] = 1;
		...
		reached[0][76] = 1;
		;
		/* merge: futex.num_waiting = (futex.num_waiting-1)(79, 77, 79) */
		reached[0][77] = 1;
...
#endif
		;
		/* merge: num_woken = (num_woken+1)(79, 78, 79) */
		reached[0][78] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 30: /* STATE 69 - ../../../futex.pml:80 - [(futex.wait[2])] (79:0:3 - 1) */
		IfNotBlocked
		reached[0][69] = 1;
		if (!(((int)now.futex.wait[2])))
			continue;
		/* merge: futex.wait[2] = 0(79, 70, 79) */
		reached[0][70] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 31: /* STATE 71 - ../../../futex.pml:83 - [(futex.wait[3])] (79:0:3 - 1) */
		IfNotBlocked
		reached[0][71] = 1;
		if (!(((int)now.futex.wait[3])))
			continue;
		/* merge: futex.wait[3] = 0(79, 72, 79) */
		reached[0][72] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 32: /* STATE 73 - ../../../futex.pml:87 - [(futex.wait[4])] (79:0:3 - 1) */
		IfNotBlocked
		reached[0][73] = 1;
		if (!(((int)now.futex.wait[4])))
			continue;
		/* merge: futex.wait[4] = 0(79, 74, 79) */
		reached[0][74] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 33: /* STATE 77 - ../../../futex.pml:89 - [futex.num_waiting = (futex.num_waiting-1)] (0:79:2 - 5) */
		IfNotBlocked
		reached[0][77] = 1;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 34: /* STATE 82 - ../../../futex.pml:92 - [printf('T%d woke up %d thread(s)\\n',_pid,num_woken)] (0:94:1 - 3) */
		IfNotBlocked
		reached[0][82] = 1;
		Printf("T%d woke up %d thread(s)\n", ((int)((P0 *)this)->_pid), ((int)((P0 *)this)->_2_num_woken));
		/* merge: num_woken = 0(94, 83, 94) */
		...
		;
		_m = 3; goto P999; /* 3 */
	case 35: /* STATE 88 - ../../../drepper_mutex3b.pml:26 - [D_STEP] */
...
S_089_0: /* 1 */
	...
	case 36: /* STATE 92 - ../../../mutex_generic.pml:29 - [printf('T%d is done\\n',_pid)] (0:0:0 - 1) */
		IfNotBlocked
		reached[0][92] = 1;
		Printf("T%d is done\n", ((int)((P0 *)this)->_pid));
		_m = 3; goto P999; /* 0 */
	case 37: /* STATE 97 - ../../../mutex_generic.pml:31 - [-end-] (0:0:0 - 3) */
		IfNotBlocked
		reached[0][97] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
