...
S_042_0: /* 1 */
	...
	case 28: /* STATE 52 - ../../../mutex_generic.pml:27 - [num_threads_in_cs = (num_threads_in_cs-1)] (0:0:1 - 1) */
		...
		;
		_m = 3; goto P999; /* 0 */
	case 29: /* STATE 58 - ../../../drepper_mutex3b.pml:19 - [D_STEP] */
		IfNotBlocked
		sv_save();
		reached[0][58] = 1;
		reached[0][t->st] = 1;
...
S_096_0: /* 1 */
	...
	case 30: /* STATE 61 - ../../../drepper_mutex3b.pml:24 - [D_STEP] */
...
S_092_0: /* 1 */
	...
	case 31: /* STATE 62 - ../../../futex.pml:70 - [assert(!(futex.wait[_pid]))] (0:87:1 - 1) */
		IfNotBlocked
		reached[0][62] = 1;
		spin_assert( !(((int)now.futex.wait[ Index(((int)((P0 *)this)->_pid), 10) ])), " !(futex.wait[_pid])", II, tt, t);
		/* merge: num_woken = 0(87, 63, 87) */
		reached[0][63] = 1;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 32: /* STATE 64 - ../../../futex.pml:74 - [(((num_woken==1)||(futex.num_waiting==0)))] (102:0:1 - 1) */
		IfNotBlocked
		reached[0][64] = 1;
		if (!(((((int)((P0 *)this)->_2_num_woken)==1)||(((int)now.futex.num_waiting)==0))))
			continue;
		/* merge: goto :b2(102, 65, 102) */
		reached[0][65] = 1;
		;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 33: /* STATE 67 - ../../../futex.pml:78 - [(futex.wait[1])] (87:0:3 - 1) */
		IfNotBlocked
		reached[0][67] = 1;
		if (!(((int)now.futex.wait[1])))
			continue;
		/* merge: futex.wait[1] = 0(87, 68, 87) */
		reached[0][68] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 34: /* STATE 69 - ../../../futex.pml:80 - [(futex.wait[2])] (87:0:3 - 1) */
		IfNotBlocked
		reached[0][69] = 1;
		if (!(((int)now.futex.wait[2])))
			continue;
		/* merge: futex.wait[2] = 0(87, 70, 87) */
		reached[0][70] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 35: /* STATE 71 - ../../../futex.pml:83 - [(futex.wait[3])] (87:0:3 - 1) */
		IfNotBlocked
		reached[0][71] = 1;
		if (!(((int)now.futex.wait[3])))
			continue;
		/* merge: futex.wait[3] = 0(87, 72, 87) */
		reached[0][72] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 36: /* STATE 73 - ../../../futex.pml:87 - [(futex.wait[4])] (87:0:3 - 1) */
		IfNotBlocked
		reached[0][73] = 1;
		if (!(((int)now.futex.wait[4])))
			continue;
		/* merge: futex.wait[4] = 0(87, 74, 87) */
		reached[0][74] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 37: /* STATE 75 - ../../../futex.pml:91 - [(futex.wait[5])] (87:0:3 - 1) */
		IfNotBlocked
		reached[0][75] = 1;
		if (!(((int)now.futex.wait[5])))
			continue;
		/* merge: futex.wait[5] = 0(87, 76, 87) */
		reached[0][76] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 38: /* STATE 77 - ../../../futex.pml:95 - [(futex.wait[6])] (87:0:3 - 1) */
		IfNotBlocked
		reached[0][77] = 1;
		if (!(((int)now.futex.wait[6])))
			continue;
		/* merge: futex.wait[6] = 0(87, 78, 87) */
		reached[0][78] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 39: /* STATE 79 - ../../../futex.pml:99 - [(futex.wait[7])] (87:0:3 - 1) */
		IfNotBlocked
		reached[0][79] = 1;
		if (!(((int)now.futex.wait[7])))
			continue;
		/* merge: futex.wait[7] = 0(87, 80, 87) */
		reached[0][80] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 40: /* STATE 81 - ../../../futex.pml:103 - [(futex.wait[8])] (87:0:3 - 1) */
		IfNotBlocked
		reached[0][81] = 1;
		if (!(((int)now.futex.wait[8])))
			continue;
		/* merge: futex.wait[8] = 0(87, 82, 87) */
		reached[0][82] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 41: /* STATE 85 - ../../../futex.pml:105 - [futex.num_waiting = (futex.num_waiting-1)] (0:87:2 - 9) */
		IfNotBlocked
		reached[0][85] = 1;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 42: /* STATE 90 - ../../../futex.pml:108 - [printf('T%d woke up %d thread(s)\\n',_pid,num_woken)] (0:102:1 - 3) */
		IfNotBlocked
		reached[0][90] = 1;
		Printf("T%d woke up %d thread(s)\n", ((int)((P0 *)this)->_pid), ((int)((P0 *)this)->_2_num_woken));
		/* merge: num_woken = 0(102, 91, 102) */
		...
		;
		_m = 3; goto P999; /* 3 */
	case 43: /* STATE 96 - ../../../drepper_mutex3b.pml:26 - [D_STEP] */
...
S_097_0: /* 1 */
	...
	case 44: /* STATE 100 - ../../../mutex_generic.pml:29 - [printf('T%d is done\\n',_pid)] (0:0:0 - 1) */
		IfNotBlocked
		reached[0][100] = 1;
		Printf("T%d is done\n", ((int)((P0 *)this)->_pid));
		_m = 3; goto P999; /* 0 */
	case 45: /* STATE 105 - ../../../mutex_generic.pml:31 - [-end-] (0:0:0 - 3) */
		IfNotBlocked
		reached[0][105] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
