...
/*** Generated by Spin Version 6.1.0 -- 4 May 2011 ***/
...
{	int j, h = now._nr_pr;
	...
	case 0:	/* Thread */
		...
		/* params: */
		/* locals: */
		((P0 *)pptr(h))->_2_old_value = 0;
		((P0 *)pptr(h))->_2_prev = 0;
		((P0 *)pptr(h))->_2_tmp = 0;
		((P0 *)pptr(h))->_2_cur = 0;
		((P0 *)pptr(h))->_2_num_woken = 0;
#ifdef VAR_RANGES
		logval("Thread:old_value", ((P0 *)pptr(h))->_2_old_value);
		logval("Thread:prev", ((P0 *)pptr(h))->_2_prev);
		logval("Thread:tmp", ((P0 *)pptr(h))->_2_tmp);
		logval("Thread:cur", ((P0 *)pptr(h))->_2_cur);
		logval("Thread:num_woken", ((P0 *)pptr(h))->_2_num_woken);
#endif
#ifdef HAS_CODE
		locinit0(h);
#endif
...
{	/* int i; */
	...
	printf("	byte   old_value:	%d\n", ((P0 *)pptr(pid))->_2_old_value);
	printf("	byte   prev:	%d\n", ((P0 *)pptr(pid))->_2_prev);
	printf("	byte   tmp:	%d\n", ((P0 *)pptr(pid))->_2_tmp);
	printf("	byte   cur:	%d\n", ((P0 *)pptr(pid))->_2_cur);
	printf("	byte   num_woken:	%d\n", ((P0 *)pptr(pid))->_2_num_woken);
		break;
	}
}
void
