...
/*** From source: ../../../drepper_mutex3b.pml ***/
...
{	/* int i; */
	...
	printf("	byte   old_value:	%d\n", ((P0 *)pptr(pid))->old_value);
		break;
	}
}
void
