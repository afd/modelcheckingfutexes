...
S_042_0: /* 1 */
	...
	case 34: /* STATE 52 - ../../../mutex_generic.pml:27 - [num_threads_in_cs = (num_threads_in_cs-1)] (0:0:1 - 1) */
		...
		;
		_m = 3; goto P999; /* 0 */
	case 35: /* STATE 58 - ../../../drepper_mutex3b.pml:19 - [D_STEP] */
		IfNotBlocked
		sv_save();
		reached[0][58] = 1;
		reached[0][t->st] = 1;
...
S_108_0: /* 1 */
	...
	case 36: /* STATE 61 - ../../../drepper_mutex3b.pml:24 - [D_STEP] */
...
S_104_0: /* 1 */
	...
	case 37: /* STATE 62 - ../../../futex.pml:80 - [assert(!(futex.wait[_pid]))] (0:99:1 - 1) */
		IfNotBlocked
		reached[0][62] = 1;
		spin_assert( !(((int)now.futex.wait[ Index(((int)((P0 *)this)->_pid), 16) ])), " !(futex.wait[_pid])", II, tt, t);
		/* merge: num_woken = 0(99, 63, 99) */
		reached[0][63] = 1;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 38: /* STATE 64 - ../../../futex.pml:84 - [(((num_woken==1)||(futex.num_waiting==0)))] (114:0:1 - 1) */
		IfNotBlocked
		reached[0][64] = 1;
		if (!(((((int)((P0 *)this)->_2_num_woken)==1)||(((int)now.futex.num_waiting)==0))))
			continue;
		/* merge: goto :b2(114, 65, 114) */
		reached[0][65] = 1;
		;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 39: /* STATE 67 - ../../../futex.pml:88 - [(futex.wait[1])] (99:0:3 - 1) */
		IfNotBlocked
		reached[0][67] = 1;
		if (!(((int)now.futex.wait[1])))
			continue;
		/* merge: futex.wait[1] = 0(99, 68, 99) */
		reached[0][68] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 40: /* STATE 69 - ../../../futex.pml:90 - [(futex.wait[2])] (99:0:3 - 1) */
		IfNotBlocked
		reached[0][69] = 1;
		if (!(((int)now.futex.wait[2])))
			continue;
		/* merge: futex.wait[2] = 0(99, 70, 99) */
		reached[0][70] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 41: /* STATE 71 - ../../../futex.pml:93 - [(futex.wait[3])] (99:0:3 - 1) */
		IfNotBlocked
		reached[0][71] = 1;
		if (!(((int)now.futex.wait[3])))
			continue;
		/* merge: futex.wait[3] = 0(99, 72, 99) */
		reached[0][72] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 42: /* STATE 73 - ../../../futex.pml:97 - [(futex.wait[4])] (99:0:3 - 1) */
		IfNotBlocked
		reached[0][73] = 1;
		if (!(((int)now.futex.wait[4])))
			continue;
		/* merge: futex.wait[4] = 0(99, 74, 99) */
		reached[0][74] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 43: /* STATE 75 - ../../../futex.pml:101 - [(futex.wait[5])] (99:0:3 - 1) */
		IfNotBlocked
		reached[0][75] = 1;
		if (!(((int)now.futex.wait[5])))
			continue;
		/* merge: futex.wait[5] = 0(99, 76, 99) */
		reached[0][76] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 44: /* STATE 77 - ../../../futex.pml:105 - [(futex.wait[6])] (99:0:3 - 1) */
		IfNotBlocked
		reached[0][77] = 1;
		if (!(((int)now.futex.wait[6])))
			continue;
		/* merge: futex.wait[6] = 0(99, 78, 99) */
		reached[0][78] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 45: /* STATE 79 - ../../../futex.pml:109 - [(futex.wait[7])] (99:0:3 - 1) */
		IfNotBlocked
		reached[0][79] = 1;
		if (!(((int)now.futex.wait[7])))
			continue;
		/* merge: futex.wait[7] = 0(99, 80, 99) */
		reached[0][80] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 46: /* STATE 81 - ../../../futex.pml:113 - [(futex.wait[8])] (99:0:3 - 1) */
		IfNotBlocked
		reached[0][81] = 1;
		if (!(((int)now.futex.wait[8])))
			continue;
		/* merge: futex.wait[8] = 0(99, 82, 99) */
		reached[0][82] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 47: /* STATE 83 - ../../../futex.pml:117 - [(futex.wait[9])] (99:0:3 - 1) */
		IfNotBlocked
		reached[0][83] = 1;
		if (!(((int)now.futex.wait[9])))
			continue;
		/* merge: futex.wait[9] = 0(99, 84, 99) */
		reached[0][84] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 48: /* STATE 85 - ../../../futex.pml:121 - [(futex.wait[10])] (99:0:3 - 1) */
		IfNotBlocked
		reached[0][85] = 1;
		if (!(((int)now.futex.wait[10])))
			continue;
		/* merge: futex.wait[10] = 0(99, 86, 99) */
		reached[0][86] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 49: /* STATE 87 - ../../../futex.pml:125 - [(futex.wait[11])] (99:0:3 - 1) */
		IfNotBlocked
		reached[0][87] = 1;
		if (!(((int)now.futex.wait[11])))
			continue;
		/* merge: futex.wait[11] = 0(99, 88, 99) */
		reached[0][88] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 50: /* STATE 89 - ../../../futex.pml:129 - [(futex.wait[12])] (99:0:3 - 1) */
		IfNotBlocked
		reached[0][89] = 1;
		if (!(((int)now.futex.wait[12])))
			continue;
		/* merge: futex.wait[12] = 0(99, 90, 99) */
		reached[0][90] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 51: /* STATE 91 - ../../../futex.pml:133 - [(futex.wait[13])] (99:0:3 - 1) */
		IfNotBlocked
		reached[0][91] = 1;
		if (!(((int)now.futex.wait[13])))
			continue;
		/* merge: futex.wait[13] = 0(99, 92, 99) */
		reached[0][92] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 52: /* STATE 93 - ../../../futex.pml:137 - [(futex.wait[14])] (99:0:3 - 1) */
		IfNotBlocked
		reached[0][93] = 1;
		if (!(((int)now.futex.wait[14])))
			continue;
		/* merge: futex.wait[14] = 0(99, 94, 99) */
		reached[0][94] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 53: /* STATE 97 - ../../../futex.pml:139 - [futex.num_waiting = (futex.num_waiting-1)] (0:99:2 - 15) */
		IfNotBlocked
		reached[0][97] = 1;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 54: /* STATE 102 - ../../../futex.pml:142 - [printf('T%d woke up %d thread(s)\\n',_pid,num_woken)] (0:114:1 - 3) */
		IfNotBlocked
		reached[0][102] = 1;
		Printf("T%d woke up %d thread(s)\n", ((int)((P0 *)this)->_pid), ((int)((P0 *)this)->_2_num_woken));
		/* merge: num_woken = 0(114, 103, 114) */
		...
		;
		_m = 3; goto P999; /* 3 */
	case 55: /* STATE 108 - ../../../drepper_mutex3b.pml:26 - [D_STEP] */
...
S_109_0: /* 1 */
	...
	case 56: /* STATE 112 - ../../../mutex_generic.pml:29 - [printf('T%d is done\\n',_pid)] (0:0:0 - 1) */
		IfNotBlocked
		reached[0][112] = 1;
		Printf("T%d is done\n", ((int)((P0 *)this)->_pid));
		_m = 3; goto P999; /* 0 */
	case 57: /* STATE 117 - ../../../mutex_generic.pml:31 - [-end-] (0:0:0 - 3) */
		IfNotBlocked
		reached[0][117] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
