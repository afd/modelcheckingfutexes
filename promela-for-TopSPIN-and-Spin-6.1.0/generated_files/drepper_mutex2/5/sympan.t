...
{	Trans *T;
	...
	trans[2][6]	= settr(118,0,8,4,4,"(run Monitor())", 0, 2, 0);
	trans[2][8]	= settr(120,0,0,5,5,"-end-", 0, 3500, 0);
...
/*->*/	trans[0][71]	= settr(70,32,97,28,28,"D_STEP", 1, 2, 0);
	...
	trans[0][72]	= settr(71,2,91,29,29,"assert(!(futex.wait[_pid]))", 1, 2, 0); /* m: 73 -> 0,91 */
	reached0[73] = 1;
	...
	trans[0][74]	= settr(73,0,106,30,30,"(((num_woken==1)||(futex.num_waiting==0)))", 1, 2, 0); /* m: 94 -> 106,0 */
	reached0[94] = 1;
	...
	trans[0][77]	= settr(76,2,91,31,31,"(futex.wait[1])", 1, 2, 0); /* m: 78 -> 91,0 */
	reached0[78] = 1;
	trans[0][78]	= settr(0,0,0,0,0,"futex.wait[1] = 0",0,0,0);
	trans[0][88]	= settr(87,2,89,1,0,".(goto)", 1, 2, 0); /* m: 89 -> 0,91 */
	reached0[89] = 1;
	trans[0][79]	= settr(78,2,91,32,32,"(futex.wait[2])", 1, 2, 0); /* m: 80 -> 91,0 */
	reached0[80] = 1;
	trans[0][80]	= settr(0,0,0,0,0,"futex.wait[2] = 0",0,0,0);
	trans[0][81]	= settr(80,2,91,33,33,"(futex.wait[3])", 1, 2, 0); /* m: 82 -> 91,0 */
	reached0[82] = 1;
	trans[0][82]	= settr(0,0,0,0,0,"futex.wait[3] = 0",0,0,0);
	trans[0][83]	= settr(82,2,91,34,34,"(futex.wait[4])", 1, 2, 0); /* m: 84 -> 91,0 */
	reached0[84] = 1;
	trans[0][84]	= settr(0,0,0,0,0,"futex.wait[4] = 0",0,0,0);
	trans[0][85]	= settr(84,2,91,35,35,"(futex.wait[5])", 1, 2, 0); /* m: 86 -> 91,0 */
	reached0[86] = 1;
