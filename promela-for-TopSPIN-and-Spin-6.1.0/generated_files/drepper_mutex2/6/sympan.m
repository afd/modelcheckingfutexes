...
S_098_0: /* 1 */
	...
	case 29: /* STATE 72 - line 70 "../../../futex.pml" - [assert(!(futex.wait[_pid]))] (0:93:1 - 1) */
		IfNotBlocked
		reached[0][72] = 1;
		assert( !(((int)now.futex.wait[ Index(((int)((P0 *)this)->_pid), 8) ])), " !(futex.wait[_pid])", II, tt, t);
		...
		;
		_m = 3; goto P999; /* 2 */
	case 30: /* STATE 74 - line 74 "../../../futex.pml" - [(((num_woken==1)||(futex.num_waiting==0)))] (108:0:1 - 1) */
		IfNotBlocked
		reached[0][74] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 31: /* STATE 77 - line 78 "../../../futex.pml" - [(futex.wait[1])] (93:0:3 - 1) */
		IfNotBlocked
		reached[0][77] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 32: /* STATE 79 - line 80 "../../../futex.pml" - [(futex.wait[2])] (93:0:3 - 1) */
		IfNotBlocked
		reached[0][79] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 33: /* STATE 81 - line 83 "../../../futex.pml" - [(futex.wait[3])] (93:0:3 - 1) */
		IfNotBlocked
		reached[0][81] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 34: /* STATE 83 - line 87 "../../../futex.pml" - [(futex.wait[4])] (93:0:3 - 1) */
		IfNotBlocked
		reached[0][83] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 35: /* STATE 85 - line 91 "../../../futex.pml" - [(futex.wait[5])] (93:0:3 - 1) */
		IfNotBlocked
		reached[0][85] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 36: /* STATE 87 - line 95 "../../../futex.pml" - [(futex.wait[6])] (93:0:3 - 1) */
		IfNotBlocked
		reached[0][87] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 37: /* STATE 91 - line 97 "../../../futex.pml" - [futex.num_waiting = (futex.num_waiting-1)] (0:93:2 - 7) */
		IfNotBlocked
		reached[0][91] = 1;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 38: /* STATE 96 - line 100 "../../../futex.pml" - [printf('T%d woke up %d thread(s)\\n',_pid,num_woken)] (0:108:1 - 3) */
		IfNotBlocked
		reached[0][96] = 1;
		Printf("T%d woke up %d thread(s)\n", ((int)((P0 *)this)->_pid), ((int)((P0 *)this)->num_woken));
		/* merge: num_woken = 0(108, 97, 108) */
		...
		;
		_m = 3; goto P999; /* 3 */
	case 39: /* STATE 102 - line 76 "../../../drepper_mutex2.pml" - [D_STEP] */
...
S_103_0: /* 1 */
	...
	case 40: /* STATE 106 - line 22 "../../../mutex_generic.pml" - [printf('T%d is done\\n',_pid)] (0:0:0 - 1) */
		IfNotBlocked
		reached[0][106] = 1;
		Printf("T%d is done\n", ((int)((P0 *)this)->_pid));
		_m = 3; goto P999; /* 0 */
	case 41: /* STATE 111 - line 24 "../../../mutex_generic.pml" - [-end-] (0:0:0 - 3) */
		IfNotBlocked
		reached[0][111] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
