...
{	Trans *T;
	...
	trans[2][10]	= settr(130,0,12,12,12,"(run Monitor())", 0, 2, 0);
	trans[2][12]	= settr(132,0,0,13,13,"-end-", 0, 3500, 0);
	...
	trans[1][1]	= settr(117,4,4,14,14,"((num_threads_in_cs>1))", 1, 2, 0); /* m: 2 -> 4,0 */
	reached1[2] = 1;
	trans[1][2]	= settr(0,0,0,0,0,"assert(0)",0,0,0);
	trans[1][4]	= settr(120,0,0,15,15,"-end-", 0, 3500, 0);
...
/*->*/	trans[0][3]	= settr(2,34,10,16,16,"D_STEP", 1, 2, 0);
	...
	trans[0][13]	= settr(12,4,42,20,20,"((old_value==2))", 1, 2, 0); /* m: 26 -> 42,0 */
	reached0[26] = 1;
	trans[0][26]	= settr(25,0,42,21,21,".(goto)", 1, 2, 0);
	trans[0][14]	= settr(13,2,15,2,0,"else", 1, 2, 0);
	trans[0][15]	= settr(14,2,19,22,0,"assert((old_value==1))", 1, 2, 0);
	T = trans[ 0][19] = settr(18,0,0,0,0,"sub-sequence", 1, 2, 0);
	T->nxt	= settr(18,0,18,0,0,"sub-sequence", 1, 2, 0);
/*->*/	trans[0][18]	= settr(17,34,23,23,23,"D_STEP", 1, 2, 0);
	T = trans[0][23] = settr(22,2,0,0,0,"IF", 1, 2, 0);
	T = T->nxt	= settr(22,2,20,0,0,"IF", 1, 2, 0);
	    T->nxt	= settr(22,2,22,0,0,"IF", 1, 2, 0);
	trans[0][20]	= settr(19,4,54,24,24,"((old_value==0))", 1, 2, 0); /* m: 21 -> 54,0 */
	reached0[21] = 1;
	trans[0][21]	= settr(20,0,54,1,0,"goto retry", 1, 2, 0);
	trans[0][24]	= settr(23,4,42,25,25,".(goto)", 1, 2, 0); /* m: 26 -> 0,42 */
	reached0[26] = 1;
...
/*->*/	trans[0][33]	= settr(32,32,36,26,26,"D_STEP", 1, 2, 0);
/*->*/	trans[0][36]	= settr(35,32,54,27,27,"D_STEP", 1, 2, 0);
	trans[0][41]	= settr(40,0,54,1,0,".(goto)", 0, 2, 0);
/*->*/	trans[0][39]	= settr(38,32,54,28,28,"D_STEP", 1, 2, 0);
...
/*->*/	trans[0][71]	= settr(70,32,105,36,36,"D_STEP", 1, 2, 0);
	...
	trans[0][72]	= settr(71,2,99,37,37,"assert(!(futex.wait[_pid]))", 1, 2, 0); /* m: 73 -> 0,99 */
	reached0[73] = 1;
	...
	trans[0][74]	= settr(73,0,114,38,38,"(((num_woken==1)||(futex.num_waiting==0)))", 1, 2, 0); /* m: 102 -> 114,0 */
	reached0[102] = 1;
	...
	trans[0][77]	= settr(76,2,99,39,39,"(futex.wait[1])", 1, 2, 0); /* m: 78 -> 99,0 */
	reached0[78] = 1;
	trans[0][78]	= settr(0,0,0,0,0,"futex.wait[1] = 0",0,0,0);
	trans[0][96]	= settr(95,2,97,1,0,".(goto)", 1, 2, 0); /* m: 97 -> 0,99 */
	reached0[97] = 1;
	trans[0][79]	= settr(78,2,99,40,40,"(futex.wait[2])", 1, 2, 0); /* m: 80 -> 99,0 */
	reached0[80] = 1;
	trans[0][80]	= settr(0,0,0,0,0,"futex.wait[2] = 0",0,0,0);
	trans[0][81]	= settr(80,2,99,41,41,"(futex.wait[3])", 1, 2, 0); /* m: 82 -> 99,0 */
	reached0[82] = 1;
	trans[0][82]	= settr(0,0,0,0,0,"futex.wait[3] = 0",0,0,0);
	trans[0][83]	= settr(82,2,99,42,42,"(futex.wait[4])", 1, 2, 0); /* m: 84 -> 99,0 */
	reached0[84] = 1;
	trans[0][84]	= settr(0,0,0,0,0,"futex.wait[4] = 0",0,0,0);
	trans[0][85]	= settr(84,2,99,43,43,"(futex.wait[5])", 1, 2, 0); /* m: 86 -> 99,0 */
	reached0[86] = 1;
	trans[0][86]	= settr(0,0,0,0,0,"futex.wait[5] = 0",0,0,0);
	trans[0][87]	= settr(86,2,99,44,44,"(futex.wait[6])", 1, 2, 0); /* m: 88 -> 99,0 */
	reached0[88] = 1;
	trans[0][88]	= settr(0,0,0,0,0,"futex.wait[6] = 0",0,0,0);
	trans[0][89]	= settr(88,2,99,45,45,"(futex.wait[7])", 1, 2, 0); /* m: 90 -> 99,0 */
	reached0[90] = 1;
	trans[0][90]	= settr(0,0,0,0,0,"futex.wait[7] = 0",0,0,0);
	trans[0][91]	= settr(90,2,99,46,46,"(futex.wait[8])", 1, 2, 0); /* m: 92 -> 99,0 */
	reached0[92] = 1;
	trans[0][92]	= settr(0,0,0,0,0,"futex.wait[8] = 0",0,0,0);
	trans[0][93]	= settr(92,2,99,47,47,"(futex.wait[9])", 1, 2, 0); /* m: 94 -> 99,0 */
	reached0[94] = 1;
	trans[0][94]	= settr(0,0,0,0,0,"futex.wait[9] = 0",0,0,0);
	trans[0][97]	= settr(96,2,99,48,48,"futex.num_waiting = (futex.num_waiting-1)", 1, 2, 0); /* m: 98 -> 0,99 */
	reached0[98] = 1;
	trans[0][98]	= settr(0,0,0,0,0,"num_woken = (num_woken+1)",0,0,0);
	trans[0][101]	= settr(100,2,102,1,0,"break", 1, 2, 0);
	trans[0][102]	= settr(101,0,114,49,49,"printf('T%d woke up %d thread(s)\\n',_pid,num_woken)", 1, 2, 0); /* m: 103 -> 0,114 */
	reached0[103] = 1;
	trans[0][103]	= settr(0,0,0,0,0,"num_woken = 0",0,0,0);
	trans[0][110]	= settr(109,0,114,1,0,".(goto)", 0, 2, 0);
/*->*/	trans[0][108]	= settr(107,32,114,50,50,"D_STEP", 0, 2, 0);
	trans[0][112]	= settr(111,0,117,51,0,"printf('T%d is done\\n',_pid)", 0, 2, 0);
	trans[0][113]	= settr(112,0,117,1,0,"goto :b0", 0, 2, 0);
	trans[0][116]	= settr(115,0,117,1,0,"break", 0, 2, 0);
	trans[0][117]	= settr(116,0,0,52,52,"-end-", 0, 3500, 0);
	/* np_ demon: */
