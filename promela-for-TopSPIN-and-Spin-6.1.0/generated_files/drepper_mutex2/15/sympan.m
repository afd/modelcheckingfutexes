...
S_009_0: /* 1 */
	...
	case 23: /* STATE 5 - ../../../drepper_mutex2.pml:20 - [((old_value==0))] (58:0:1 - 1) */
		IfNotBlocked
		reached[0][5] = 1;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 24: /* STATE 11 - ../../../drepper_mutex2.pml:27 - [.(goto)] (0:55:0 - 1) */
		IfNotBlocked
		reached[0][11] = 1;
		;
		/* merge: .(goto)(0, 56, 55) */
		...
		;
		_m = 3; goto P999; /* 1 */
	case 25: /* STATE 9 - ../../../drepper_mutex2.pml:24 - [printf('T%d fails to lock mutex on fast path\\n',_pid)] (0:55:0 - 1) */
		IfNotBlocked
		reached[0][9] = 1;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 26: /* STATE 13 - ../../../drepper_mutex2.pml:31 - [((old_value==2))] (42:0:1 - 1) */
		IfNotBlocked
		reached[0][13] = 1;
		...
		;
		_m = 3; goto P999; /* 1 */
	case 27: /* STATE 26 - ../../../drepper_mutex2.pml:40 - [.(goto)] (0:42:0 - 2) */
		IfNotBlocked
		reached[0][26] = 1;
		;
		_m = 3; goto P999; /* 0 */
	case 28: /* STATE 15 - ../../../drepper_mutex2.pml:33 - [assert((old_value==1))] (0:0:0 - 1) */
		IfNotBlocked
		reached[0][15] = 1;
		spin_assert((((int)((P0 *)this)->_2_old_value)==1), "(old_value==1)", II, tt, t);
		_m = 3; goto P999; /* 0 */
	case 29: /* STATE 18 - ../../../atomics.pml:3 - [D_STEP] */
		IfNotBlocked
		sv_save();
		reached[0][18] = 1;
		reached[0][t->st] = 1;
...
S_022_0: /* 1 */
	...
	case 30: /* STATE 20 - ../../../drepper_mutex2.pml:36 - [((old_value==0))] (54:0:1 - 1) */
		IfNotBlocked
		reached[0][20] = 1;
		if (!((((int)((P0 *)this)->_2_old_value)==0)))
			continue;
		...
		;
		_m = 3; goto P999; /* 1 */
	case 31: /* STATE 24 - ../../../drepper_mutex2.pml:39 - [.(goto)] (0:42:0 - 1) */
		IfNotBlocked
		reached[0][24] = 1;
		;
		/* merge: .(goto)(42, 26, 42) */
		...
		;
		_m = 3; goto P999; /* 1 */
	case 32: /* STATE 33 - ../../../futex.pml:17 - [D_STEP] */
...
S_035_0: /* 1 */
	...
	case 33: /* STATE 36 - ../../../futex.pml:27 - [D_STEP] */
...
S_040_0: /* 1 */
	...
	case 34: /* STATE 39 - ../../../futex.pml:31 - [D_STEP] */
...
S_037_0: /* 2 */
	...
	case 35: /* STATE 45 - ../../../atomics.pml:3 - [D_STEP] */
		IfNotBlocked
		sv_save();
		reached[0][45] = 1;
		reached[0][t->st] = 1;
...
S_051_0: /* 1 */
	...
	case 36: /* STATE 47 - ../../../drepper_mutex2.pml:46 - [((old_value==0))] (58:0:1 - 1) */
		IfNotBlocked
		reached[0][47] = 1;
		if (!((((int)((P0 *)this)->_2_old_value)==0)))
			continue;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 37: /* STATE 53 - ../../../drepper_mutex2.pml:55 - [.(goto)] (0:55:0 - 1) */
		IfNotBlocked
		reached[0][53] = 1;
		;
		/* merge: .(goto)(0, 56, 55) */
		...
		;
		_m = 3; goto P999; /* 1 */
	case 38: /* STATE 51 - ../../../drepper_mutex2.pml:52 - [printf('T%d fails to lock mutex on slow path\\n',_pid)] (0:55:0 - 1) */
		IfNotBlocked
		reached[0][51] = 1;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 39: /* STATE 60 - ../../../mutex_generic.pml:26 - [num_threads_in_cs = (num_threads_in_cs+1)] (0:0:1 - 1) */
		IfNotBlocked
		reached[0][60] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 40: /* STATE 61 - ../../../mutex_generic.pml:27 - [num_threads_in_cs = (num_threads_in_cs-1)] (0:0:1 - 1) */
		IfNotBlocked
		reached[0][61] = 1;
		(trpt+1)->bup.oval = ((int)now.num_threads_in_cs);
		now.num_threads_in_cs = (((int)now.num_threads_in_cs)-1);
		...
		;
		_m = 3; goto P999; /* 0 */
	case 41: /* STATE 67 - ../../../drepper_mutex2.pml:61 - [D_STEP] */
		IfNotBlocked
		sv_save();
		reached[0][67] = 1;
		reached[0][t->st] = 1;
...
S_061_0: /* 2 */
		...
		;
S_062_0: /* 2 */
		now.futex.word = ( ((((int)now.futex.word)==0)) ? ((15+1)) : ((((int)now.futex.word)-1)) );
#ifdef VAR_RANGES
		logval("futex.word", ((int)now.futex.word));
#endif
		;
...
S_120_0: /* 1 */
	...
	case 42: /* STATE 71 - ../../../drepper_mutex2.pml:67 - [D_STEP] */
...
S_116_0: /* 1 */
	...
	case 43: /* STATE 72 - ../../../futex.pml:80 - [assert(!(futex.wait[_pid]))] (0:111:1 - 1) */
		IfNotBlocked
		reached[0][72] = 1;
		spin_assert( !(((int)now.futex.wait[ Index(((int)((P0 *)this)->_pid), 17) ])), " !(futex.wait[_pid])", II, tt, t);
		/* merge: num_woken = 0(111, 73, 111) */
		reached[0][73] = 1;
	...
	case 44: /* STATE 74 - ../../../futex.pml:84 - [(((num_woken==1)||(futex.num_waiting==0)))] (126:0:1 - 1) */
		...
		;
		_m = 3; goto P999; /* 5 */
	case 45: /* STATE 77 - ../../../futex.pml:88 - [(futex.wait[1])] (111:0:3 - 1) */
		IfNotBlocked
		reached[0][77] = 1;
		if (!(((int)now.futex.wait[1])))
			continue;
		/* merge: futex.wait[1] = 0(111, 78, 111) */
		reached[0][78] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 46: /* STATE 79 - ../../../futex.pml:90 - [(futex.wait[2])] (111:0:3 - 1) */
		IfNotBlocked
		reached[0][79] = 1;
		if (!(((int)now.futex.wait[2])))
			continue;
		/* merge: futex.wait[2] = 0(111, 80, 111) */
		reached[0][80] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 47: /* STATE 81 - ../../../futex.pml:93 - [(futex.wait[3])] (111:0:3 - 1) */
		IfNotBlocked
		reached[0][81] = 1;
		if (!(((int)now.futex.wait[3])))
			continue;
		/* merge: futex.wait[3] = 0(111, 82, 111) */
		reached[0][82] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 48: /* STATE 83 - ../../../futex.pml:97 - [(futex.wait[4])] (111:0:3 - 1) */
		IfNotBlocked
		reached[0][83] = 1;
		if (!(((int)now.futex.wait[4])))
			continue;
		/* merge: futex.wait[4] = 0(111, 84, 111) */
		reached[0][84] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 49: /* STATE 85 - ../../../futex.pml:101 - [(futex.wait[5])] (111:0:3 - 1) */
		IfNotBlocked
		reached[0][85] = 1;
		if (!(((int)now.futex.wait[5])))
			continue;
		/* merge: futex.wait[5] = 0(111, 86, 111) */
		reached[0][86] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 50: /* STATE 87 - ../../../futex.pml:105 - [(futex.wait[6])] (111:0:3 - 1) */
		IfNotBlocked
		reached[0][87] = 1;
		if (!(((int)now.futex.wait[6])))
			continue;
		/* merge: futex.wait[6] = 0(111, 88, 111) */
		reached[0][88] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 51: /* STATE 89 - ../../../futex.pml:109 - [(futex.wait[7])] (111:0:3 - 1) */
		IfNotBlocked
		reached[0][89] = 1;
		if (!(((int)now.futex.wait[7])))
			continue;
		/* merge: futex.wait[7] = 0(111, 90, 111) */
		reached[0][90] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 52: /* STATE 91 - ../../../futex.pml:113 - [(futex.wait[8])] (111:0:3 - 1) */
		IfNotBlocked
		reached[0][91] = 1;
		if (!(((int)now.futex.wait[8])))
			continue;
		/* merge: futex.wait[8] = 0(111, 92, 111) */
		reached[0][92] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 53: /* STATE 93 - ../../../futex.pml:117 - [(futex.wait[9])] (111:0:3 - 1) */
		IfNotBlocked
		reached[0][93] = 1;
		if (!(((int)now.futex.wait[9])))
			continue;
		/* merge: futex.wait[9] = 0(111, 94, 111) */
		reached[0][94] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 54: /* STATE 95 - ../../../futex.pml:121 - [(futex.wait[10])] (111:0:3 - 1) */
		IfNotBlocked
		reached[0][95] = 1;
		if (!(((int)now.futex.wait[10])))
			continue;
		/* merge: futex.wait[10] = 0(111, 96, 111) */
		reached[0][96] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 55: /* STATE 97 - ../../../futex.pml:125 - [(futex.wait[11])] (111:0:3 - 1) */
		IfNotBlocked
		reached[0][97] = 1;
		if (!(((int)now.futex.wait[11])))
			continue;
		/* merge: futex.wait[11] = 0(111, 98, 111) */
		reached[0][98] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 56: /* STATE 99 - ../../../futex.pml:129 - [(futex.wait[12])] (111:0:3 - 1) */
		IfNotBlocked
		reached[0][99] = 1;
		if (!(((int)now.futex.wait[12])))
			continue;
		/* merge: futex.wait[12] = 0(111, 100, 111) */
		reached[0][100] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 57: /* STATE 101 - ../../../futex.pml:133 - [(futex.wait[13])] (111:0:3 - 1) */
		IfNotBlocked
		reached[0][101] = 1;
		if (!(((int)now.futex.wait[13])))
			continue;
		/* merge: futex.wait[13] = 0(111, 102, 111) */
		reached[0][102] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 58: /* STATE 103 - ../../../futex.pml:137 - [(futex.wait[14])] (111:0:3 - 1) */
		IfNotBlocked
		reached[0][103] = 1;
		if (!(((int)now.futex.wait[14])))
			continue;
		/* merge: futex.wait[14] = 0(111, 104, 111) */
		reached[0][104] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 59: /* STATE 105 - ../../../futex.pml:141 - [(futex.wait[15])] (111:0:3 - 1) */
		IfNotBlocked
		reached[0][105] = 1;
		if (!(((int)now.futex.wait[15])))
			continue;
		/* merge: futex.wait[15] = 0(111, 106, 111) */
		reached[0][106] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 60: /* STATE 109 - ../../../futex.pml:148 - [futex.num_waiting = (futex.num_waiting-1)] (0:111:2 - 16) */
		IfNotBlocked
		reached[0][109] = 1;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 61: /* STATE 114 - ../../../futex.pml:151 - [printf('T%d woke up %d thread(s)\\n',_pid,num_woken)] (0:126:1 - 3) */
		IfNotBlocked
		reached[0][114] = 1;
		Printf("T%d woke up %d thread(s)\n", ((int)((P0 *)this)->_pid), ((int)((P0 *)this)->_2_num_woken));
		/* merge: num_woken = 0(126, 115, 126) */
		...
		;
		_m = 3; goto P999; /* 3 */
	case 62: /* STATE 120 - ../../../drepper_mutex2.pml:73 - [D_STEP] */
...
S_121_0: /* 1 */
	...
	case 63: /* STATE 124 - ../../../mutex_generic.pml:29 - [printf('T%d is done\\n',_pid)] (0:0:0 - 1) */
		IfNotBlocked
		reached[0][124] = 1;
		Printf("T%d is done\n", ((int)((P0 *)this)->_pid));
		_m = 3; goto P999; /* 0 */
	case 64: /* STATE 129 - ../../../mutex_generic.pml:31 - [-end-] (0:0:0 - 3) */
		IfNotBlocked
		reached[0][129] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
