...
{	Trans *T;
	...
	T = trans[ 2][5] = settr(113,2,0,0,0,"ATOMIC", 0, 2, 0);
	...
	trans[2][4]	= settr(112,0,6,6,6,"(run Monitor())", 0, 2, 0);
	trans[2][6]	= settr(114,0,0,7,7,"-end-", 0, 3500, 0);
	...
	trans[1][1]	= settr(105,4,4,8,8,"((num_threads_in_cs>1))", 1, 2, 0); /* m: 2 -> 4,0 */
	reached1[2] = 1;
	trans[1][2]	= settr(0,0,0,0,0,"assert(0)",0,0,0);
	trans[1][4]	= settr(108,0,0,9,9,"-end-", 0, 3500, 0);
	...
	T = T->nxt	= settr(101,0,59,0,0,"DO", 0, 2, 0);
...
/*->*/	trans[0][3]	= settr(2,34,10,10,10,"D_STEP", 1, 2, 0);
	...
	trans[0][13]	= settr(12,4,42,14,14,"((old_value==2))", 1, 2, 0); /* m: 26 -> 42,0 */
	reached0[26] = 1;
	trans[0][26]	= settr(25,0,42,15,15,".(goto)", 1, 2, 0);
	trans[0][14]	= settr(13,2,15,2,0,"else", 1, 2, 0);
	trans[0][15]	= settr(14,2,19,16,0,"assert((old_value==1))", 1, 2, 0);
	T = trans[ 0][19] = settr(18,0,0,0,0,"sub-sequence", 1, 2, 0);
	T->nxt	= settr(18,0,18,0,0,"sub-sequence", 1, 2, 0);
/*->*/	trans[0][18]	= settr(17,34,23,17,17,"D_STEP", 1, 2, 0);
	T = trans[0][23] = settr(22,2,0,0,0,"IF", 1, 2, 0);
	T = T->nxt	= settr(22,2,20,0,0,"IF", 1, 2, 0);
	    T->nxt	= settr(22,2,22,0,0,"IF", 1, 2, 0);
	trans[0][20]	= settr(19,4,54,18,18,"((old_value==0))", 1, 2, 0); /* m: 21 -> 54,0 */
	reached0[21] = 1;
	trans[0][21]	= settr(20,0,54,1,0,"goto retry", 1, 2, 0);
	trans[0][24]	= settr(23,4,42,19,19,".(goto)", 1, 2, 0); /* m: 26 -> 0,42 */
	reached0[26] = 1;
...
/*->*/	trans[0][33]	= settr(32,32,36,20,20,"D_STEP", 1, 2, 0);
/*->*/	trans[0][36]	= settr(35,32,54,21,21,"D_STEP", 1, 2, 0);
	trans[0][41]	= settr(40,0,54,1,0,".(goto)", 0, 2, 0);
/*->*/	trans[0][39]	= settr(38,32,54,22,22,"D_STEP", 1, 2, 0);
...
/*->*/	trans[0][45]	= settr(44,34,52,23,23,"D_STEP", 1, 2, 0);
	T = trans[0][52] = settr(51,2,0,0,0,"IF", 1, 2, 0);
	T = T->nxt	= settr(51,2,47,0,0,"IF", 1, 2, 0);
	    T->nxt	= settr(51,2,50,0,0,"IF", 1, 2, 0);
	trans[0][47]	= settr(46,4,58,24,24,"((old_value==0))", 1, 2, 0); /* m: 48 -> 58,0 */
	reached0[48] = 1;
	trans[0][48]	= settr(0,0,0,0,0,"printf('T%d locks mutex on slow path\\n',_pid)",0,0,0);
	trans[0][49]	= settr(48,0,58,1,0,"goto acquired_mutex", 1, 2, 0);
	trans[0][53]	= settr(52,0,55,25,25,".(goto)", 1, 2, 0);
	trans[0][50]	= settr(49,2,51,2,0,"else", 1, 2, 0);
	trans[0][51]	= settr(50,0,55,26,26,"printf('T%d fails to lock mutex on slow path\\n',_pid)", 1, 2, 0); /* m: 53 -> 0,55 */
	reached0[53] = 1;
	trans[0][57]	= settr(56,0,58,1,0,"break", 0, 2, 0);
	trans[0][58]	= settr(57,0,60,1,0,"(1)", 0, 2, 0);
	trans[0][60]	= settr(59,0,61,27,27,"num_threads_in_cs = (num_threads_in_cs+1)", 1, 2, 0);
	trans[0][61]	= settr(60,0,99,28,28,"num_threads_in_cs = (num_threads_in_cs-1)", 1, 2, 0);
	T = trans[ 0][99] = settr(98,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(98,0,67,0,0,"sub-sequence", 0, 2, 0);
/*->*/	trans[0][67]	= settr(66,32,97,29,29,"D_STEP", 1, 2, 0);
	T = trans[0][97] = settr(96,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(96,0,71,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(96,0,96,0,0,"IF", 0, 2, 0);
/*->*/	trans[0][71]	= settr(70,32,93,30,30,"D_STEP", 1, 2, 0);
	...
	T->nxt	= settr(91,2,72,0,0,"ATOMIC", 1, 2, 0);
	trans[0][72]	= settr(71,2,87,31,31,"assert(!(futex.wait[_pid]))", 1, 2, 0); /* m: 73 -> 0,87 */
	reached0[73] = 1;
	...
	T = T->nxt	= settr(86,2,74,0,0,"DO", 1, 2, 0);
	    T->nxt	= settr(86,2,76,0,0,"DO", 1, 2, 0);
	trans[0][74]	= settr(73,0,102,32,32,"(((num_woken==1)||(futex.num_waiting==0)))", 1, 2, 0); /* m: 90 -> 102,0 */
	reached0[90] = 1;
	trans[0][75]	= settr(74,2,90,1,0,"goto :b2", 1, 2, 0); /* m: 90 -> 0,102 */
	reached0[90] = 1;
	trans[0][76]	= settr(75,2,83,2,0,"else", 1, 2, 0);
