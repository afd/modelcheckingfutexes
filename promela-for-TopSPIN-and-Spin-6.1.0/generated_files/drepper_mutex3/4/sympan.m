...
S_047_0: /* 1 */
	...
	case 12: /* STATE 5 - ../../../drepper_mutex3x_lock.pml:7 - [((old_value!=0))] (17:0:0 - 1) */
		IfNotBlocked
		reached[0][5] = 1;
		...
		_m = 3; goto P999; /* 1 */
	case 13: /* STATE 8 - ../../../drepper_mutex3x_lock.pml:12 - [((old_value==2))] (42:0:0 - 1) */
		IfNotBlocked
		reached[0][8] = 1;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 14: /* STATE 10 - ../../../drepper_mutex3x_lock.pml:13 - [assert((old_value==1))] (0:0:0 - 1) */
		IfNotBlocked
		reached[0][10] = 1;
		spin_assert((((int)((P0 *)this)->_2_old_value)==1), "(old_value==1)", II, tt, t);
		_m = 3; goto P999; /* 0 */
	case 15: /* STATE 13 - ../../../atomics.pml:13 - [D_STEP] */
		IfNotBlocked
		sv_save();
		reached[0][13] = 1;
		reached[0][t->st] = 1;
...
S_015_0: /* 1 */
	...
	case 16: /* STATE 18 - ../../../drepper_mutex3x_lock.pml:18 - [((old_value==0))] (51:0:1 - 1) */
		IfNotBlocked
		reached[0][18] = 1;
		if (!((((int)((P0 *)this)->_2_old_value)==0)))
			continue;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 17: /* STATE 22 - ../../../drepper_mutex3x_lock.pml:22 - [printf('T%d fails to lock mutex on slow path\\n',_pid)] (0:0:0 - 1) */
		IfNotBlocked
		reached[0][22] = 1;
		Printf("T%d fails to lock mutex on slow path\n", ((int)((P0 *)this)->_pid));
		_m = 3; goto P999; /* 0 */
	case 18: /* STATE 28 - ../../../futex.pml:17 - [D_STEP] */
...
S_030_0: /* 1 */
	...
	case 19: /* STATE 31 - ../../../futex.pml:27 - [D_STEP] */
...
S_035_0: /* 1 */
	...
	case 20: /* STATE 34 - ../../../futex.pml:31 - [D_STEP] */
...
S_032_0: /* 2 */
	...
	case 21: /* STATE 40 - ../../../atomics.pml:13 - [D_STEP] */
		IfNotBlocked
		sv_save();
		reached[0][40] = 1;
		reached[0][t->st] = 1;
...
S_042_0: /* 1 */
	...
	case 22: /* STATE 46 - ../../../drepper_mutex3x_lock.pml:27 - [printf('T%d locks mutex on fast path\\n',_pid)] (0:0:0 - 1) */
		IfNotBlocked
		reached[0][46] = 1;
		Printf("T%d locks mutex on fast path\n", ((int)((P0 *)this)->_pid));
		_m = 3; goto P999; /* 0 */
	case 23: /* STATE 51 - ../../../mutex_generic.pml:26 - [num_threads_in_cs = (num_threads_in_cs+1)] (0:0:1 - 5) */
		IfNotBlocked
		reached[0][51] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 24: /* STATE 52 - ../../../mutex_generic.pml:27 - [num_threads_in_cs = (num_threads_in_cs-1)] (0:0:1 - 1) */
		IfNotBlocked
		reached[0][52] = 1;
		(trpt+1)->bup.oval = ((int)now.num_threads_in_cs);
		now.num_threads_in_cs = (((int)now.num_threads_in_cs)-1);
		...
		;
		_m = 3; goto P999; /* 0 */
	case 25: /* STATE 58 - ../../../drepper_mutex3.pml:19 - [D_STEP] */
		IfNotBlocked
		sv_save();
		reached[0][58] = 1;
		reached[0][t->st] = 1;
...
S_089_0: /* 1 */
	...
	case 26: /* STATE 62 - ../../../drepper_mutex3.pml:24 - [D_STEP] */
...
S_085_0: /* 1 */
	...
	case 27: /* STATE 63 - ../../../futex.pml:70 - [assert(!(futex.wait[_pid]))] (0:80:1 - 1) */
		IfNotBlocked
		reached[0][63] = 1;
		spin_assert( !(((int)now.futex.wait[ Index(((int)((P0 *)this)->_pid), 6) ])), " !(futex.wait[_pid])", II, tt, t);
		/* merge: num_woken = 0(80, 64, 80) */
		reached[0][64] = 1;
	...
	case 28: /* STATE 65 - ../../../futex.pml:74 - [(((num_woken==1)||(futex.num_waiting==0)))] (95:0:1 - 1) */
		...
		;
		_m = 3; goto P999; /* 5 */
	case 29: /* STATE 68 - ../../../futex.pml:78 - [(futex.wait[1])] (80:0:3 - 1) */
		IfNotBlocked
		reached[0][68] = 1;
		if (!(((int)now.futex.wait[1])))
			continue;
		/* merge: futex.wait[1] = 0(80, 69, 80) */
		reached[0][69] = 1;
		...
		reached[0][77] = 1;
		;
		/* merge: futex.num_waiting = (futex.num_waiting-1)(80, 78, 80) */
		reached[0][78] = 1;
...
#endif
		;
		/* merge: num_woken = (num_woken+1)(80, 79, 80) */
		reached[0][79] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 30: /* STATE 70 - ../../../futex.pml:80 - [(futex.wait[2])] (80:0:3 - 1) */
		IfNotBlocked
		reached[0][70] = 1;
		if (!(((int)now.futex.wait[2])))
			continue;
		/* merge: futex.wait[2] = 0(80, 71, 80) */
		reached[0][71] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 31: /* STATE 72 - ../../../futex.pml:83 - [(futex.wait[3])] (80:0:3 - 1) */
		IfNotBlocked
		reached[0][72] = 1;
		if (!(((int)now.futex.wait[3])))
			continue;
		/* merge: futex.wait[3] = 0(80, 73, 80) */
		reached[0][73] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 32: /* STATE 74 - ../../../futex.pml:87 - [(futex.wait[4])] (80:0:3 - 1) */
		IfNotBlocked
		reached[0][74] = 1;
		if (!(((int)now.futex.wait[4])))
			continue;
		/* merge: futex.wait[4] = 0(80, 75, 80) */
		reached[0][75] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 33: /* STATE 78 - ../../../futex.pml:89 - [futex.num_waiting = (futex.num_waiting-1)] (0:80:2 - 5) */
		IfNotBlocked
		reached[0][78] = 1;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 34: /* STATE 83 - ../../../futex.pml:92 - [printf('T%d woke up %d thread(s)\\n',_pid,num_woken)] (0:95:1 - 3) */
		IfNotBlocked
		reached[0][83] = 1;
		Printf("T%d woke up %d thread(s)\n", ((int)((P0 *)this)->_pid), ((int)((P0 *)this)->_2_num_woken));
		/* merge: num_woken = 0(95, 84, 95) */
		...
		;
		_m = 3; goto P999; /* 3 */
	case 35: /* STATE 89 - ../../../drepper_mutex3.pml:26 - [D_STEP] */
...
S_090_0: /* 1 */
	...
	case 36: /* STATE 93 - ../../../mutex_generic.pml:29 - [printf('T%d is done\\n',_pid)] (0:0:0 - 1) */
		IfNotBlocked
		reached[0][93] = 1;
		Printf("T%d is done\n", ((int)((P0 *)this)->_pid));
		_m = 3; goto P999; /* 0 */
	case 37: /* STATE 98 - ../../../mutex_generic.pml:31 - [-end-] (0:0:0 - 3) */
		IfNotBlocked
		reached[0][98] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
