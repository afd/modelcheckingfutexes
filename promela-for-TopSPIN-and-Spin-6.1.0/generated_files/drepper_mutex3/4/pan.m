...
S_085_0: /* 1 */
	...
	case 24: /* STATE 63 - line 70 "../../../futex.pml" - [assert(!(futex.wait[_pid]))] (0:80:1 - 1) */
		IfNotBlocked
		reached[0][63] = 1;
		assert( !(((int)now.futex.wait[ Index(((int)((P0 *)this)->_pid), 6) ])), " !(futex.wait[_pid])", II, tt, t);
		...
		;
		_m = 3; goto P999; /* 2 */
	case 25: /* STATE 65 - line 74 "../../../futex.pml" - [(((num_woken==1)||(futex.num_waiting==0)))] (95:0:1 - 1) */
		IfNotBlocked
		reached[0][65] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 26: /* STATE 68 - line 78 "../../../futex.pml" - [(futex.wait[1])] (80:0:3 - 1) */
		IfNotBlocked
		reached[0][68] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 27: /* STATE 70 - line 80 "../../../futex.pml" - [(futex.wait[2])] (80:0:3 - 1) */
		IfNotBlocked
		reached[0][70] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 28: /* STATE 72 - line 83 "../../../futex.pml" - [(futex.wait[3])] (80:0:3 - 1) */
		IfNotBlocked
		reached[0][72] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 29: /* STATE 74 - line 87 "../../../futex.pml" - [(futex.wait[4])] (80:0:3 - 1) */
		IfNotBlocked
		reached[0][74] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 30: /* STATE 78 - line 89 "../../../futex.pml" - [futex.num_waiting = (futex.num_waiting-1)] (0:80:2 - 5) */
		IfNotBlocked
		reached[0][78] = 1;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 31: /* STATE 83 - line 92 "../../../futex.pml" - [printf('T%d woke up %d thread(s)\\n',_pid,num_woken)] (0:95:1 - 3) */
		IfNotBlocked
		reached[0][83] = 1;
		Printf("T%d woke up %d thread(s)\n", ((int)((P0 *)this)->_pid), ((int)((P0 *)this)->num_woken));
		/* merge: num_woken = 0(95, 84, 95) */
		...
		;
		_m = 3; goto P999; /* 3 */
	case 32: /* STATE 89 - line 27 "../../../drepper_mutex3.pml" - [D_STEP] */
...
S_090_0: /* 1 */
	...
	case 33: /* STATE 93 - line 22 "../../../mutex_generic.pml" - [printf('T%d is done\\n',_pid)] (0:0:0 - 1) */
		IfNotBlocked
		reached[0][93] = 1;
		Printf("T%d is done\n", ((int)((P0 *)this)->_pid));
		_m = 3; goto P999; /* 0 */
	case 34: /* STATE 98 - line 24 "../../../mutex_generic.pml" - [-end-] (0:0:0 - 3) */
		IfNotBlocked
		reached[0][98] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
