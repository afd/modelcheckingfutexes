...
S_042_0: /* 1 */
	...
	case 27: /* STATE 52 - ../../../mutex_generic.pml:27 - [num_threads_in_cs = (num_threads_in_cs-1)] (0:0:1 - 1) */
		...
		;
		_m = 3; goto P999; /* 0 */
	case 28: /* STATE 58 - ../../../drepper_mutex3.pml:19 - [D_STEP] */
		IfNotBlocked
		sv_save();
		reached[0][58] = 1;
		reached[0][t->st] = 1;
...
S_095_0: /* 1 */
	...
	case 29: /* STATE 62 - ../../../drepper_mutex3.pml:24 - [D_STEP] */
...
S_091_0: /* 1 */
	...
	case 30: /* STATE 63 - ../../../futex.pml:70 - [assert(!(futex.wait[_pid]))] (0:86:1 - 1) */
		IfNotBlocked
		reached[0][63] = 1;
		spin_assert( !(((int)now.futex.wait[ Index(((int)((P0 *)this)->_pid), 9) ])), " !(futex.wait[_pid])", II, tt, t);
		...
		;
		_m = 3; goto P999; /* 2 */
	case 31: /* STATE 65 - ../../../futex.pml:74 - [(((num_woken==1)||(futex.num_waiting==0)))] (101:0:1 - 1) */
		IfNotBlocked
		reached[0][65] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 32: /* STATE 68 - ../../../futex.pml:78 - [(futex.wait[1])] (86:0:3 - 1) */
		IfNotBlocked
		reached[0][68] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 33: /* STATE 70 - ../../../futex.pml:80 - [(futex.wait[2])] (86:0:3 - 1) */
		IfNotBlocked
		reached[0][70] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 34: /* STATE 72 - ../../../futex.pml:83 - [(futex.wait[3])] (86:0:3 - 1) */
		IfNotBlocked
		reached[0][72] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 35: /* STATE 74 - ../../../futex.pml:87 - [(futex.wait[4])] (86:0:3 - 1) */
		IfNotBlocked
		reached[0][74] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 36: /* STATE 76 - ../../../futex.pml:91 - [(futex.wait[5])] (86:0:3 - 1) */
		IfNotBlocked
		reached[0][76] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 37: /* STATE 78 - ../../../futex.pml:95 - [(futex.wait[6])] (86:0:3 - 1) */
		IfNotBlocked
		reached[0][78] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 38: /* STATE 80 - ../../../futex.pml:99 - [(futex.wait[7])] (86:0:3 - 1) */
		IfNotBlocked
		reached[0][80] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 39: /* STATE 84 - ../../../futex.pml:101 - [futex.num_waiting = (futex.num_waiting-1)] (0:86:2 - 8) */
		IfNotBlocked
		reached[0][84] = 1;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 40: /* STATE 89 - ../../../futex.pml:104 - [printf('T%d woke up %d thread(s)\\n',_pid,num_woken)] (0:101:1 - 3) */
		IfNotBlocked
		reached[0][89] = 1;
		Printf("T%d woke up %d thread(s)\n", ((int)((P0 *)this)->_pid), ((int)((P0 *)this)->_2_num_woken));
		/* merge: num_woken = 0(101, 90, 101) */
		...
		;
		_m = 3; goto P999; /* 3 */
	case 41: /* STATE 95 - ../../../drepper_mutex3.pml:26 - [D_STEP] */
...
S_096_0: /* 1 */
	...
	case 42: /* STATE 99 - ../../../mutex_generic.pml:29 - [printf('T%d is done\\n',_pid)] (0:0:0 - 1) */
		IfNotBlocked
		reached[0][99] = 1;
		Printf("T%d is done\n", ((int)((P0 *)this)->_pid));
		_m = 3; goto P999; /* 0 */
	case 43: /* STATE 104 - ../../../mutex_generic.pml:31 - [-end-] (0:0:0 - 3) */
		IfNotBlocked
		reached[0][104] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
