...
S_091_0: /* 1 */
	...
	case 24: /* STATE 63 - line 70 "../../../futex.pml" - [assert(!(futex.wait[_pid]))] (0:86:1 - 1) */
		IfNotBlocked
		reached[0][63] = 1;
		assert( !(((int)now.futex.wait[ Index(((int)((P0 *)this)->_pid), 9) ])), " !(futex.wait[_pid])", II, tt, t);
		/* merge: num_woken = 0(86, 64, 86) */
		reached[0][64] = 1;
	...
	case 25: /* STATE 65 - line 74 "../../../futex.pml" - [(((num_woken==1)||(futex.num_waiting==0)))] (101:0:1 - 1) */
		...
		;
		_m = 3; goto P999; /* 5 */
	case 26: /* STATE 68 - line 78 "../../../futex.pml" - [(futex.wait[1])] (86:0:3 - 1) */
		IfNotBlocked
		reached[0][68] = 1;
		if (!(((int)now.futex.wait[1])))
			continue;
		/* merge: futex.wait[1] = 0(86, 69, 86) */
		reached[0][69] = 1;
		...
		reached[0][83] = 1;
		;
		/* merge: futex.num_waiting = (futex.num_waiting-1)(86, 84, 86) */
		reached[0][84] = 1;
...
#endif
		;
		/* merge: num_woken = (num_woken+1)(86, 85, 86) */
		reached[0][85] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 27: /* STATE 70 - line 80 "../../../futex.pml" - [(futex.wait[2])] (86:0:3 - 1) */
		IfNotBlocked
		reached[0][70] = 1;
		if (!(((int)now.futex.wait[2])))
			continue;
		/* merge: futex.wait[2] = 0(86, 71, 86) */
		reached[0][71] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 28: /* STATE 72 - line 83 "../../../futex.pml" - [(futex.wait[3])] (86:0:3 - 1) */
		IfNotBlocked
		reached[0][72] = 1;
		if (!(((int)now.futex.wait[3])))
			continue;
		/* merge: futex.wait[3] = 0(86, 73, 86) */
		reached[0][73] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 29: /* STATE 74 - line 87 "../../../futex.pml" - [(futex.wait[4])] (86:0:3 - 1) */
		IfNotBlocked
		reached[0][74] = 1;
		if (!(((int)now.futex.wait[4])))
			continue;
		/* merge: futex.wait[4] = 0(86, 75, 86) */
		reached[0][75] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 30: /* STATE 76 - line 91 "../../../futex.pml" - [(futex.wait[5])] (86:0:3 - 1) */
		IfNotBlocked
		reached[0][76] = 1;
		if (!(((int)now.futex.wait[5])))
			continue;
		/* merge: futex.wait[5] = 0(86, 77, 86) */
		reached[0][77] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 31: /* STATE 78 - line 95 "../../../futex.pml" - [(futex.wait[6])] (86:0:3 - 1) */
		IfNotBlocked
		reached[0][78] = 1;
		if (!(((int)now.futex.wait[6])))
			continue;
		/* merge: futex.wait[6] = 0(86, 79, 86) */
		reached[0][79] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 32: /* STATE 80 - line 99 "../../../futex.pml" - [(futex.wait[7])] (86:0:3 - 1) */
		IfNotBlocked
		reached[0][80] = 1;
		if (!(((int)now.futex.wait[7])))
			continue;
		/* merge: futex.wait[7] = 0(86, 81, 86) */
		reached[0][81] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 33: /* STATE 84 - line 101 "../../../futex.pml" - [futex.num_waiting = (futex.num_waiting-1)] (0:86:2 - 8) */
		IfNotBlocked
		reached[0][84] = 1;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 34: /* STATE 89 - line 104 "../../../futex.pml" - [printf('T%d woke up %d thread(s)\\n',_pid,num_woken)] (0:101:1 - 3) */
		IfNotBlocked
		reached[0][89] = 1;
		Printf("T%d woke up %d thread(s)\n", ((int)((P0 *)this)->_pid), ((int)((P0 *)this)->num_woken));
		/* merge: num_woken = 0(101, 90, 101) */
		...
		;
		_m = 3; goto P999; /* 3 */
	case 35: /* STATE 95 - line 27 "../../../drepper_mutex3.pml" - [D_STEP] */
...
S_096_0: /* 1 */
	...
	case 36: /* STATE 99 - line 22 "../../../mutex_generic.pml" - [printf('T%d is done\\n',_pid)] (0:0:0 - 1) */
		IfNotBlocked
		reached[0][99] = 1;
		Printf("T%d is done\n", ((int)((P0 *)this)->_pid));
		_m = 3; goto P999; /* 0 */
	case 37: /* STATE 104 - line 24 "../../../mutex_generic.pml" - [-end-] (0:0:0 - 3) */
		IfNotBlocked
		reached[0][104] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
