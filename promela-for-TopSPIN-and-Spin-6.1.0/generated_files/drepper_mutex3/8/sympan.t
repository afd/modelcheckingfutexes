...
{	Trans *T;
	...
	trans[2][2]	= /* c */ settr(111,2,3,3,3,"(run Thread())", 0, 2, 0);
	trans[2][3]	= /* c */ settr(112,2,4,3,3,"(run Thread())", 0, 2, 0);
	trans[2][4]	= /* c */ settr(113,2,5,3,3,"(run Thread())", 0, 2, 0);
	trans[2][5]	= /* c */ settr(114,2,6,3,3,"(run Thread())", 0, 2, 0);
	trans[2][6]	= /* c */ settr(115,2,7,3,3,"(run Thread())", 0, 2, 0);
	trans[2][7]	= /* c */ settr(116,2,8,3,3,"(run Thread())", 0, 2, 0);
	trans[2][8]	= /* c */ settr(117,2,9,3,3,"(run Thread())", 0, 2, 0);
	trans[2][9]	= settr(118,0,11,4,4,"(run Monitor())", 0, 2, 0);
	trans[2][11]	= settr(120,0,0,5,5,"-end-", 0, 3500, 0);
	...
	trans[1][1]	= settr(106,4,4,6,6,"((num_threads_in_cs>1))", 1, 2, 0); /* m: 2 -> 4,0 */
	reached1[2] = 1;
	trans[1][2]	= settr(0,0,0,0,0,"assert(0)",0,0,0);
	trans[1][4]	= settr(109,0,0,7,7,"-end-", 0, 3500, 0);
...
/*->*/	trans[0][62]	= settr(61,32,94,23,23,"D_STEP", 1, 2, 0);
	...
	trans[0][63]	= settr(62,2,88,24,24,"assert(!(futex.wait[_pid]))", 1, 2, 0); /* m: 64 -> 0,88 */
	reached0[64] = 1;
	...
	trans[0][65]	= settr(64,0,103,25,25,"(((num_woken==1)||(futex.num_waiting==0)))", 1, 2, 0); /* m: 91 -> 103,0 */
	reached0[91] = 1;
	...
	trans[0][68]	= settr(67,2,88,26,26,"(futex.wait[1])", 1, 2, 0); /* m: 69 -> 88,0 */
	reached0[69] = 1;
	trans[0][69]	= settr(0,0,0,0,0,"futex.wait[1] = 0",0,0,0);
	trans[0][85]	= settr(84,2,86,1,0,".(goto)", 1, 2, 0); /* m: 86 -> 0,88 */
	reached0[86] = 1;
	trans[0][70]	= settr(69,2,88,27,27,"(futex.wait[2])", 1, 2, 0); /* m: 71 -> 88,0 */
	reached0[71] = 1;
	trans[0][71]	= settr(0,0,0,0,0,"futex.wait[2] = 0",0,0,0);
	trans[0][72]	= settr(71,2,88,28,28,"(futex.wait[3])", 1, 2, 0); /* m: 73 -> 88,0 */
	reached0[73] = 1;
	trans[0][73]	= settr(0,0,0,0,0,"futex.wait[3] = 0",0,0,0);
	trans[0][74]	= settr(73,2,88,29,29,"(futex.wait[4])", 1, 2, 0); /* m: 75 -> 88,0 */
	reached0[75] = 1;
	trans[0][75]	= settr(0,0,0,0,0,"futex.wait[4] = 0",0,0,0);
	trans[0][76]	= settr(75,2,88,30,30,"(futex.wait[5])", 1, 2, 0); /* m: 77 -> 88,0 */
	reached0[77] = 1;
	trans[0][77]	= settr(0,0,0,0,0,"futex.wait[5] = 0",0,0,0);
	trans[0][78]	= settr(77,2,88,31,31,"(futex.wait[6])", 1, 2, 0); /* m: 79 -> 88,0 */
	reached0[79] = 1;
	trans[0][79]	= settr(0,0,0,0,0,"futex.wait[6] = 0",0,0,0);
	trans[0][80]	= settr(79,2,88,32,32,"(futex.wait[7])", 1, 2, 0); /* m: 81 -> 88,0 */
	reached0[81] = 1;
	trans[0][81]	= settr(0,0,0,0,0,"futex.wait[7] = 0",0,0,0);
	trans[0][82]	= settr(81,2,88,33,33,"(futex.wait[8])", 1, 2, 0); /* m: 83 -> 88,0 */
	reached0[83] = 1;
	trans[0][83]	= settr(0,0,0,0,0,"futex.wait[8] = 0",0,0,0);
	trans[0][86]	= settr(85,2,88,34,34,"futex.num_waiting = (futex.num_waiting-1)", 1, 2, 0); /* m: 87 -> 0,88 */
	reached0[87] = 1;
	trans[0][87]	= settr(0,0,0,0,0,"num_woken = (num_woken+1)",0,0,0);
	trans[0][90]	= settr(89,2,91,1,0,"break", 1, 2, 0);
	trans[0][91]	= settr(90,0,103,35,35,"printf('T%d woke up %d thread(s)\\n',_pid,num_woken)", 1, 2, 0); /* m: 92 -> 0,103 */
	reached0[92] = 1;
	trans[0][92]	= settr(0,0,0,0,0,"num_woken = 0",0,0,0);
	trans[0][99]	= settr(98,0,103,1,0,".(goto)", 0, 2, 0);
/*->*/	trans[0][97]	= settr(96,32,103,36,36,"D_STEP", 0, 2, 0);
	trans[0][101]	= settr(100,0,106,37,0,"printf('T%d is done\\n',_pid)", 0, 2, 0);
	trans[0][102]	= settr(101,0,106,1,0,"goto :b0", 0, 2, 0);
	trans[0][105]	= settr(104,0,106,1,0,"break", 0, 2, 0);
	trans[0][106]	= settr(105,0,0,38,38,"-end-", 0, 3500, 0);
	/* np_ demon: */
