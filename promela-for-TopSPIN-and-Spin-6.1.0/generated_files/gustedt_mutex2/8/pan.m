...
S_009_0: /* 1 */
	...
	case 16: /* STATE 5 - ../../../gustedt_mutex2.pml:24 - [((cur==0))] (77:0:1 - 1) */
		IfNotBlocked
		reached[0][5] = 1;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 17: /* STATE 11 - ../../../gustedt_mutex2.pml:28 - [.(goto)] (0:31:0 - 1) */
		IfNotBlocked
		reached[0][11] = 1;
		;
		/* merge: .(goto)(0, 32, 31) */
		...
		;
		_m = 3; goto P999; /* 1 */
	case 18: /* STATE 9 - ../../../gustedt_mutex2.pml:26 - [printf('T%d fails to lock mutex on fast path\\n',_pid)] (0:31:0 - 1) */
		IfNotBlocked
		reached[0][9] = 1;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 19: /* STATE 16 - ../../../gustedt_mutex2.pml:34 - [(((1<<7)&cur))] (24:0:1 - 1) */
		IfNotBlocked
		reached[0][16] = 1;
		if (!(((1<<7)&((int)((P0 *)this)->_2_cur))))
			continue;
		/* merge: cur = ( (((((1<<7)-1)&cur)==0)) -> ((8+1)) : (((((1<<7)-1)&cur)-1)) )(0, 17, 24) */
		reached[0][17] = 1;
		(trpt+1)->bup.oval = ((int)((P0 *)this)->_2_cur);
		((P0 *)this)->_2_cur = ( (((((1<<7)-1)&((int)((P0 *)this)->_2_cur))==0)) ? ((8+1)) : (((((1<<7)-1)&((int)((P0 *)this)->_2_cur))-1)) );
#ifdef VAR_RANGES
		logval("Thread:cur", ((int)((P0 *)this)->_2_cur));
#endif
		;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 20: /* STATE 23 - ../../../atomics.pml:3 - [D_STEP] */
		IfNotBlocked
		sv_save();
		reached[0][23] = 1;
		reached[0][t->st] = 1;
...
S_028_0: /* 1 */
	...
	case 21: /* STATE 25 - ../../../gustedt_mutex2.pml:39 - [((cur==prev))] (0:0:2 - 1) */
		IfNotBlocked
		reached[0][25] = 1;
		...
		if (!readtrail)
			...
			((P0 *)this)->_2_prev = 0;
		_m = 3; goto P999; /* 0 */
	case 22: /* STATE 28 - ../../../gustedt_mutex2.pml:40 - [cur = prev] (0:0:1 - 1) */
		IfNotBlocked
		reached[0][28] = 1;
		(trpt+1)->bup.oval = ((int)((P0 *)this)->_2_cur);
		...
		;
		_m = 3; goto P999; /* 0 */
	case 23: /* STATE 41 - ../../../lockbit.pml:8 - [D_STEP] */
		IfNotBlocked
		sv_save();
		reached[0][41] = 1;
		reached[0][t->st] = 1;
...
S_042_0: /* 1 */
	...
	case 24: /* STATE 43 - ../../../gustedt_mutex2.pml:45 - [cur = (cur+1)] (0:74:1 - 1) */
		IfNotBlocked
		reached[0][43] = 1;
		(trpt+1)->bup.oval = ((int)((P0 *)this)->_2_cur);
		...
		;
		_m = 3; goto P999; /* 1 */
	case 25: /* STATE 44 - ../../../gustedt_mutex2.pml:49 - [(((1<<7)&cur))] (0:0:0 - 1) */
		IfNotBlocked
		reached[0][44] = 1;
		if (!(((1<<7)&((int)((P0 *)this)->_2_cur))))
			continue;
...
S_054_0: /* 2 */
	...
	case 29: /* STATE 60 - ../../../gustedt_mutex2.pml:51 - [cur = ( (((((1<<7)-1)&cur)==0)) -> ((8+1)) : (((((1<<7)-1)&cur)-1)) )] (0:67:1 - 3) */
		IfNotBlocked
		reached[0][60] = 1;
		(trpt+1)->bup.oval = ((int)((P0 *)this)->_2_cur);
		((P0 *)this)->_2_cur = ( (((((1<<7)-1)&((int)((P0 *)this)->_2_cur))==0)) ? ((8+1)) : (((((1<<7)-1)&((int)((P0 *)this)->_2_cur))-1)) );
		...
		;
		_m = 3; goto P999; /* 1 */
	case 30: /* STATE 66 - ../../../atomics.pml:3 - [D_STEP] */
		IfNotBlocked
		sv_save();
		reached[0][66] = 1;
		reached[0][t->st] = 1;
...
S_071_0: /* 1 */
	...
	case 31: /* STATE 68 - ../../../gustedt_mutex2.pml:56 - [((cur==prev))] (0:0:2 - 1) */
		IfNotBlocked
		reached[0][68] = 1;
		if (!((((int)((P0 *)this)->_2_cur)==((int)((P0 *)this)->_2_prev))))
			continue;
		...
		if (!readtrail)
			...
			((P0 *)this)->_2_prev = 0;
		_m = 3; goto P999; /* 0 */
	case 32: /* STATE 71 - ../../../gustedt_mutex2.pml:57 - [cur = prev] (0:0:1 - 1) */
		IfNotBlocked
		reached[0][71] = 1;
		(trpt+1)->bup.oval = ((int)((P0 *)this)->_2_cur);
		((P0 *)this)->_2_cur = ((int)((P0 *)this)->_2_prev);
		...
		;
		_m = 3; goto P999; /* 0 */
	case 33: /* STATE 77 - ../../../gustedt_mutex2.pml:61 - [prev = 0] (0:0:1 - 6) */
		IfNotBlocked
		reached[0][77] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 34: /* STATE 78 - ../../../gustedt_mutex2.pml:61 - [cur = 0] (0:0:1 - 1) */
		IfNotBlocked
		reached[0][78] = 1;
		(trpt+1)->bup.oval = ((int)((P0 *)this)->_2_cur);
		((P0 *)this)->_2_cur = 0;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 35: /* STATE 80 - ../../../mutex_generic.pml:26 - [num_threads_in_cs = (num_threads_in_cs+1)] (0:0:1 - 1) */
		IfNotBlocked
		reached[0][80] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 36: /* STATE 81 - ../../../mutex_generic.pml:27 - [num_threads_in_cs = (num_threads_in_cs-1)] (0:0:1 - 1) */
		IfNotBlocked
		reached[0][81] = 1;
		(trpt+1)->bup.oval = ((int)now.num_threads_in_cs);
		now.num_threads_in_cs = (((int)now.num_threads_in_cs)-1);
		...
		;
		_m = 3; goto P999; /* 0 */
	case 37: /* STATE 88 - ../../../gustedt_mutex2.pml:65 - [D_STEP] */
		IfNotBlocked
		sv_save();
		reached[0][88] = 1;
		reached[0][t->st] = 1;
...
S_122_0: /* 1 */
	...
	case 38: /* STATE 89 - ../../../gustedt_mutex2.pml:70 - [((prev!=((1<<7)|1)))] (0:0:1 - 1) */
		IfNotBlocked
		reached[0][89] = 1;
		...
		if (!readtrail)
			...
			((P0 *)this)->_2_prev = 0;
		_m = 3; goto P999; /* 0 */
	case 39: /* STATE 90 - ../../../futex.pml:70 - [assert(!(futex.wait[_pid]))] (0:115:1 - 1) */
		IfNotBlocked
		reached[0][90] = 1;
		spin_assert( !(((int)now.futex.wait[ Index(((int)((P0 *)this)->_pid), 10) ])), " !(futex.wait[_pid])", II, tt, t);
		/* merge: num_woken = 0(115, 91, 115) */
		reached[0][91] = 1;
...
#endif
		;
		/* merge: .(goto)(0, 130, 129) */
		reached[0][130] = 1;
		;
		_m = 3; goto P999; /* 6 */
	case 41: /* STATE 95 - ../../../futex.pml:78 - [(futex.wait[1])] (115:0:3 - 1) */
		IfNotBlocked
		reached[0][95] = 1;
		if (!(((int)now.futex.wait[1])))
			continue;
		/* merge: futex.wait[1] = 0(115, 96, 115) */
		reached[0][96] = 1;
...
#endif
		;
		/* merge: .(goto)(115, 112, 115) */
		reached[0][112] = 1;
		;
		/* merge: futex.num_waiting = (futex.num_waiting-1)(115, 113, 115) */
		reached[0][113] = 1;
...
#endif
		;
		/* merge: num_woken = (num_woken+1)(115, 114, 115) */
		reached[0][114] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 42: /* STATE 97 - ../../../futex.pml:80 - [(futex.wait[2])] (115:0:3 - 1) */
		IfNotBlocked
		reached[0][97] = 1;
		if (!(((int)now.futex.wait[2])))
			continue;
		/* merge: futex.wait[2] = 0(115, 98, 115) */
		reached[0][98] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 43: /* STATE 99 - ../../../futex.pml:83 - [(futex.wait[3])] (115:0:3 - 1) */
		IfNotBlocked
		reached[0][99] = 1;
		if (!(((int)now.futex.wait[3])))
			continue;
		/* merge: futex.wait[3] = 0(115, 100, 115) */
		reached[0][100] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 44: /* STATE 101 - ../../../futex.pml:87 - [(futex.wait[4])] (115:0:3 - 1) */
		IfNotBlocked
		reached[0][101] = 1;
		if (!(((int)now.futex.wait[4])))
			continue;
		/* merge: futex.wait[4] = 0(115, 102, 115) */
		reached[0][102] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 45: /* STATE 103 - ../../../futex.pml:91 - [(futex.wait[5])] (115:0:3 - 1) */
		IfNotBlocked
		reached[0][103] = 1;
		if (!(((int)now.futex.wait[5])))
			continue;
		/* merge: futex.wait[5] = 0(115, 104, 115) */
		reached[0][104] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 46: /* STATE 105 - ../../../futex.pml:95 - [(futex.wait[6])] (115:0:3 - 1) */
		IfNotBlocked
		reached[0][105] = 1;
		if (!(((int)now.futex.wait[6])))
			continue;
		/* merge: futex.wait[6] = 0(115, 106, 115) */
		reached[0][106] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 47: /* STATE 107 - ../../../futex.pml:99 - [(futex.wait[7])] (115:0:3 - 1) */
		IfNotBlocked
		reached[0][107] = 1;
		if (!(((int)now.futex.wait[7])))
			continue;
		/* merge: futex.wait[7] = 0(115, 108, 115) */
		reached[0][108] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 48: /* STATE 109 - ../../../futex.pml:103 - [(futex.wait[8])] (115:0:3 - 1) */
		IfNotBlocked
		reached[0][109] = 1;
		if (!(((int)now.futex.wait[8])))
			continue;
		/* merge: futex.wait[8] = 0(115, 110, 115) */
		reached[0][110] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 49: /* STATE 113 - ../../../futex.pml:105 - [futex.num_waiting = (futex.num_waiting-1)] (0:115:2 - 9) */
		IfNotBlocked
		reached[0][113] = 1;
		(trpt+1)->bup.ovals = grab_ints(2);
		...
		;
		_m = 3; goto P999; /* 2 */
	case 50: /* STATE 118 - ../../../futex.pml:108 - [printf('T%d woke up %d thread(s)\\n',_pid,num_woken)] (0:129:2 - 3) */
		IfNotBlocked
		reached[0][118] = 1;
		Printf("T%d woke up %d thread(s)\n", ((int)((P0 *)this)->_pid), ((int)((P0 *)this)->_2_num_woken));
		/* merge: num_woken = 0(129, 119, 129) */
		...
		;
		_m = 3; goto P999; /* 4 */
	case 51: /* STATE 125 - ../../../gustedt_mutex2.pml:73 - [prev = 0] (0:129:1 - 3) */
		IfNotBlocked
		reached[0][125] = 1;
		(trpt+1)->bup.oval = ((int)((P0 *)this)->_2_prev);
		((P0 *)this)->_2_prev = 0;
		...
		;
		_m = 3; goto P999; /* 1 */
	case 52: /* STATE 127 - ../../../mutex_generic.pml:29 - [printf('T%d is done\\n',_pid)] (0:0:0 - 1) */
		IfNotBlocked
		reached[0][127] = 1;
		Printf("T%d is done\n", ((int)((P0 *)this)->_pid));
		_m = 3; goto P999; /* 0 */
	case 53: /* STATE 132 - ../../../mutex_generic.pml:31 - [-end-] (0:0:0 - 3) */
		IfNotBlocked
		reached[0][132] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
