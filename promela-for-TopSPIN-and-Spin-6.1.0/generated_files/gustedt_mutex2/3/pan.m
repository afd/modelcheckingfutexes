#define rand	pan_rand
	...
	case 5: /* STATE 3 - ../../../mutex_generic.pml:49 - [(run Thread())] (0:0:0 - 1) */
		...
		if (!(addproc(II, 0)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 6: /* STATE 4 - ../../../mutex_generic.pml:75 - [(run Monitor())] (0:0:0 - 1) */
		IfNotBlocked
		reached[2][4] = 1;
		if (!(addproc(II, 1)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 7: /* STATE 6 - ../../../mutex_generic.pml:77 - [-end-] (0:0:0 - 1) */
		IfNotBlocked
		reached[2][6] = 1;
		...
		_m = 3; goto P999; /* 0 */
		 ...
		 /* PROC Monitor */
	case 8: /* STATE 1 - ../../../mutex_generic.pml:39 - [((num_threads_in_cs>1))] (4:0:0 - 1) */
		IfNotBlocked
		reached[1][1] = 1;
		...
		_m = 3; goto P999; /* 1 */
	case 9: /* STATE 4 - ../../../mutex_generic.pml:41 - [-end-] (0:0:0 - 1) */
		IfNotBlocked
		reached[1][4] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
		 ...
		 /* PROC Thread */
	case 10: /* STATE 3 - ../../../atomics.pml:3 - [D_STEP] */
		IfNotBlocked
		sv_save();
		reached[0][3] = 1;
		reached[0][t->st] = 1;
...
S_009_0: /* 1 */
	...
	case 11: /* STATE 5 - ../../../gustedt_mutex2.pml:24 - [((cur==0))] (77:0:1 - 1) */
		IfNotBlocked
		reached[0][5] = 1;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 12: /* STATE 11 - ../../../gustedt_mutex2.pml:28 - [.(goto)] (0:31:0 - 1) */
		IfNotBlocked
		reached[0][11] = 1;
		;
		/* merge: .(goto)(0, 32, 31) */
		...
		;
		_m = 3; goto P999; /* 1 */
	case 13: /* STATE 9 - ../../../gustedt_mutex2.pml:26 - [printf('T%d fails to lock mutex on fast path\\n',_pid)] (0:31:0 - 1) */
		IfNotBlocked
		reached[0][9] = 1;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 14: /* STATE 16 - ../../../gustedt_mutex2.pml:34 - [(((1<<7)&cur))] (24:0:1 - 1) */
		IfNotBlocked
		reached[0][16] = 1;
		if (!(((1<<7)&((int)((P0 *)this)->_2_cur))))
			continue;
		/* merge: cur = ( (((((1<<7)-1)&cur)==0)) -> ((3+1)) : (((((1<<7)-1)&cur)-1)) )(0, 17, 24) */
		reached[0][17] = 1;
		(trpt+1)->bup.oval = ((int)((P0 *)this)->_2_cur);
		((P0 *)this)->_2_cur = ( (((((1<<7)-1)&((int)((P0 *)this)->_2_cur))==0)) ? ((3+1)) : (((((1<<7)-1)&((int)((P0 *)this)->_2_cur))-1)) );
#ifdef VAR_RANGES
		logval("Thread:cur", ((int)((P0 *)this)->_2_cur));
#endif
		;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 15: /* STATE 23 - ../../../atomics.pml:3 - [D_STEP] */
		IfNotBlocked
		sv_save();
		reached[0][23] = 1;
		reached[0][t->st] = 1;
...
S_028_0: /* 1 */
	...
	case 16: /* STATE 25 - ../../../gustedt_mutex2.pml:39 - [((cur==prev))] (0:0:2 - 1) */
		IfNotBlocked
		reached[0][25] = 1;
		...
		if (!readtrail)
			...
			((P0 *)this)->_2_prev = 0;
		_m = 3; goto P999; /* 0 */
	case 17: /* STATE 28 - ../../../gustedt_mutex2.pml:40 - [cur = prev] (0:0:1 - 1) */
		IfNotBlocked
		reached[0][28] = 1;
		(trpt+1)->bup.oval = ((int)((P0 *)this)->_2_cur);
		...
		;
		_m = 3; goto P999; /* 0 */
	case 18: /* STATE 41 - ../../../lockbit.pml:8 - [D_STEP] */
		IfNotBlocked
		sv_save();
		reached[0][41] = 1;
		reached[0][t->st] = 1;
...
S_038_0: /* 2 */
S_034_0: /* 2 */
		if (!(((((1<<7)-1)&((int)now.futex.word))==(3+1))))
			goto S_038_1;
S_035_0: /* 2 */
...
S_042_0: /* 1 */
	...
	case 19: /* STATE 43 - ../../../gustedt_mutex2.pml:45 - [cur = (cur+1)] (0:74:1 - 1) */
		IfNotBlocked
		reached[0][43] = 1;
		(trpt+1)->bup.oval = ((int)((P0 *)this)->_2_cur);
		...
		;
		_m = 3; goto P999; /* 1 */
	case 20: /* STATE 44 - ../../../gustedt_mutex2.pml:49 - [(((1<<7)&cur))] (0:0:0 - 1) */
		IfNotBlocked
		reached[0][44] = 1;
		if (!(((1<<7)&((int)((P0 *)this)->_2_cur))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 21: /* STATE 50 - ../../../futex.pml:17 - [D_STEP] */
...
S_046_0: /* 2 */
		spin_assert( !(((int)now.futex.wait[ Index(((int)((P0 *)this)->_pid), 5) ])), " !(futex.wait[_pid])", II, tt, t);
S_047_0: /* 2 */
		now.futex.wait[ Index(((P0 *)this)->_pid, 5) ] = 1;
#ifdef VAR_RANGES
		logval("futex.wait[_pid]", ((int)now.futex.wait[ Index(((int)((P0 *)this)->_pid), 5) ]));
#endif
		;
S_048_0: /* 2 */
...
S_052_0: /* 1 */
	...
	case 22: /* STATE 53 - ../../../futex.pml:27 - [D_STEP] */
		if (!(boq == -1 &&  !(((int)now.futex.wait[ Index(((int)((P0 *)this)->_pid), 5) ]))))
			continue;
		sv_save();
		reached[0][53] = 1;
		reached[0][t->st] = 1;
		reached[0][tt] = 1;
S_050_0: /* 2 */
		if (!( !(((int)now.futex.wait[ Index(((int)((P0 *)this)->_pid), 5) ]))))
			Uerror("block in d_step seq");
S_051_0: /* 2 */
...
S_057_0: /* 1 */
	...
	case 23: /* STATE 56 - ../../../futex.pml:31 - [D_STEP] */
...
S_054_0: /* 2 */
	...
	case 24: /* STATE 60 - ../../../gustedt_mutex2.pml:51 - [cur = ( (((((1<<7)-1)&cur)==0)) -> ((3+1)) : (((((1<<7)-1)&cur)-1)) )] (0:67:1 - 3) */
		IfNotBlocked
		reached[0][60] = 1;
		(trpt+1)->bup.oval = ((int)((P0 *)this)->_2_cur);
		((P0 *)this)->_2_cur = ( (((((1<<7)-1)&((int)((P0 *)this)->_2_cur))==0)) ? ((3+1)) : (((((1<<7)-1)&((int)((P0 *)this)->_2_cur))-1)) );
		...
		;
		_m = 3; goto P999; /* 1 */
	case 25: /* STATE 66 - ../../../atomics.pml:3 - [D_STEP] */
		IfNotBlocked
		sv_save();
		reached[0][66] = 1;
		reached[0][t->st] = 1;
...
S_071_0: /* 1 */
	...
	case 26: /* STATE 68 - ../../../gustedt_mutex2.pml:56 - [((cur==prev))] (0:0:2 - 1) */
		IfNotBlocked
		reached[0][68] = 1;
		if (!((((int)((P0 *)this)->_2_cur)==((int)((P0 *)this)->_2_prev))))
			continue;
		...
		if (!readtrail)
			...
			((P0 *)this)->_2_prev = 0;
		_m = 3; goto P999; /* 0 */
	case 27: /* STATE 71 - ../../../gustedt_mutex2.pml:57 - [cur = prev] (0:0:1 - 1) */
		IfNotBlocked
		reached[0][71] = 1;
		(trpt+1)->bup.oval = ((int)((P0 *)this)->_2_cur);
		((P0 *)this)->_2_cur = ((int)((P0 *)this)->_2_prev);
		...
		;
		_m = 3; goto P999; /* 0 */
	case 28: /* STATE 77 - ../../../gustedt_mutex2.pml:61 - [prev = 0] (0:0:1 - 6) */
		IfNotBlocked
		reached[0][77] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 29: /* STATE 78 - ../../../gustedt_mutex2.pml:61 - [cur = 0] (0:0:1 - 1) */
		IfNotBlocked
		reached[0][78] = 1;
		(trpt+1)->bup.oval = ((int)((P0 *)this)->_2_cur);
		((P0 *)this)->_2_cur = 0;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 30: /* STATE 80 - ../../../mutex_generic.pml:26 - [num_threads_in_cs = (num_threads_in_cs+1)] (0:0:1 - 1) */
		IfNotBlocked
		reached[0][80] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 31: /* STATE 81 - ../../../mutex_generic.pml:27 - [num_threads_in_cs = (num_threads_in_cs-1)] (0:0:1 - 1) */
		IfNotBlocked
		reached[0][81] = 1;
		(trpt+1)->bup.oval = ((int)now.num_threads_in_cs);
		now.num_threads_in_cs = (((int)now.num_threads_in_cs)-1);
		...
		;
		_m = 3; goto P999; /* 0 */
	case 32: /* STATE 88 - ../../../gustedt_mutex2.pml:65 - [D_STEP] */
		IfNotBlocked
		sv_save();
		reached[0][88] = 1;
		reached[0][t->st] = 1;
...
S_082_0: /* 2 */
		...
		;
S_083_0: /* 2 */
		now.futex.word = ( ((((int)now.futex.word)==0)) ? ((3+1)) : ((((int)now.futex.word)-1)) );
#ifdef VAR_RANGES
		logval("futex.word", ((int)now.futex.word));
#endif
		;
...
S_112_0: /* 1 */
	...
	case 33: /* STATE 89 - ../../../gustedt_mutex2.pml:70 - [((prev!=((1<<7)|1)))] (0:0:1 - 1) */
		IfNotBlocked
		reached[0][89] = 1;
		...
		if (!readtrail)
			...
			((P0 *)this)->_2_prev = 0;
		_m = 3; goto P999; /* 0 */
	case 34: /* STATE 90 - ../../../futex.pml:70 - [assert(!(futex.wait[_pid]))] (0:105:1 - 1) */
		IfNotBlocked
		reached[0][90] = 1;
		spin_assert( !(((int)now.futex.wait[ Index(((int)((P0 *)this)->_pid), 5) ])), " !(futex.wait[_pid])", II, tt, t);
		/* merge: num_woken = 0(105, 91, 105) */
		reached[0][91] = 1;
	...
	case 35: /* STATE 92 - ../../../futex.pml:74 - [(((num_woken==1)||(futex.num_waiting==0)))] (119:0:2 - 1) */
...
#endif
		;
		/* merge: .(goto)(119, 114, 119) */
		reached[0][114] = 1;
		;
		/* merge: prev = 0(119, 115, 119) */
		reached[0][115] = 1;
		...
		;
		_m = 3; goto P999; /* 6 */
	case 36: /* STATE 95 - ../../../futex.pml:78 - [(futex.wait[1])] (105:0:3 - 1) */
		IfNotBlocked
		reached[0][95] = 1;
		if (!(((int)now.futex.wait[1])))
			continue;
		/* merge: futex.wait[1] = 0(105, 96, 105) */
		reached[0][96] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 37: /* STATE 97 - ../../../futex.pml:80 - [(futex.wait[2])] (105:0:3 - 1) */
		IfNotBlocked
		reached[0][97] = 1;
		if (!(((int)now.futex.wait[2])))
			continue;
		/* merge: futex.wait[2] = 0(105, 98, 105) */
		reached[0][98] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 38: /* STATE 99 - ../../../futex.pml:83 - [(futex.wait[3])] (105:0:3 - 1) */
		IfNotBlocked
		reached[0][99] = 1;
		if (!(((int)now.futex.wait[3])))
			continue;
		/* merge: futex.wait[3] = 0(105, 100, 105) */
		reached[0][100] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 5 */
	case 39: /* STATE 103 - ../../../futex.pml:85 - [futex.num_waiting = (futex.num_waiting-1)] (0:105:2 - 4) */
		IfNotBlocked
		reached[0][103] = 1;
		(trpt+1)->bup.ovals = grab_ints(2);
		...
		;
		_m = 3; goto P999; /* 2 */
	case 40: /* STATE 108 - ../../../futex.pml:88 - [printf('T%d woke up %d thread(s)\\n',_pid,num_woken)] (0:119:2 - 3) */
		IfNotBlocked
		reached[0][108] = 1;
		Printf("T%d woke up %d thread(s)\n", ((int)((P0 *)this)->_pid), ((int)((P0 *)this)->_2_num_woken));
		/* merge: num_woken = 0(119, 109, 119) */
		...
		;
		_m = 3; goto P999; /* 4 */
	case 41: /* STATE 115 - ../../../gustedt_mutex2.pml:73 - [prev = 0] (0:119:1 - 3) */
		IfNotBlocked
		reached[0][115] = 1;
		(trpt+1)->bup.oval = ((int)((P0 *)this)->_2_prev);
		((P0 *)this)->_2_prev = 0;
		...
		;
		_m = 3; goto P999; /* 1 */
	case 42: /* STATE 117 - ../../../mutex_generic.pml:29 - [printf('T%d is done\\n',_pid)] (0:0:0 - 1) */
		IfNotBlocked
		reached[0][117] = 1;
		Printf("T%d is done\n", ((int)((P0 *)this)->_pid));
		_m = 3; goto P999; /* 0 */
	case 43: /* STATE 122 - ../../../mutex_generic.pml:31 - [-end-] (0:0:0 - 3) */
		IfNotBlocked
		reached[0][122] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
