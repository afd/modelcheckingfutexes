...
{	Trans *T;
	...
	T = trans[ 2][9] = settr(129,2,0,0,0,"ATOMIC", 0, 2, 0);
	T->nxt	= settr(129,2,1,0,0,"ATOMIC", 0, 2, 0);
	...
	trans[2][8]	= settr(128,0,10,10,10,"(run Monitor())", 0, 2, 0);
	trans[2][10]	= settr(130,0,0,11,11,"-end-", 0, 3500, 0);
	...
	trans[1][1]	= settr(117,4,4,12,12,"((num_threads_in_cs>1))", 1, 2, 0); /* m: 2 -> 4,0 */
	reached1[2] = 1;
	trans[1][2]	= settr(0,0,0,0,0,"assert(0)",0,0,0);
	trans[1][4]	= settr(120,0,0,13,13,"-end-", 0, 3500, 0);
	...
	T = T->nxt	= settr(113,0,66,0,0,"DO", 0, 2, 0);
...
/*->*/	trans[0][26]	= settr(25,34,32,21,21,"D_STEP", 1, 2, 0);
	...
	trans[0][35]	= settr(34,0,40,23,23,"cur = futex.word", 1, 2, 0);
	...
	trans[0][36]	= settr(35,0,37,24,24,"(((1<<7)&cur))", 0, 2, 0);
	trans[0][37]	= settr(36,0,40,25,25,"cur = futex.word", 1, 2, 0);
...
/*->*/	trans[0][56]	= settr(55,32,60,28,28,"D_STEP", 1, 2, 0);
	trans[0][60]	= settr(59,0,62,29,29,"cur = futex.word", 1, 2, 0);
	trans[0][61]	= settr(60,0,62,1,0,"goto retry", 0, 2, 0);
	trans[0][64]	= settr(63,0,65,30,30,"tmp = 0", 0, 2, 0);
	trans[0][65]	= settr(64,0,67,31,31,"cur = 0", 0, 2, 0);
	trans[0][67]	= settr(66,0,68,32,32,"num_threads_in_cs = (num_threads_in_cs+1)", 1, 2, 0);
	trans[0][68]	= settr(67,0,111,33,33,"num_threads_in_cs = (num_threads_in_cs-1)", 1, 2, 0);
	T = trans[ 0][111] = settr(110,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(110,0,75,0,0,"sub-sequence", 0, 2, 0);
/*->*/	trans[0][75]	= settr(74,32,108,34,34,"D_STEP", 1, 2, 0);
	T = trans[0][108] = settr(107,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(107,0,76,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(107,0,107,0,0,"IF", 0, 2, 0);
	trans[0][76]	= settr(75,0,106,35,35,"((prev!=((1<<7)|1)))", 0, 2, 0);
	...
	T->nxt	= settr(104,2,77,0,0,"ATOMIC", 1, 2, 0);
	trans[0][77]	= settr(76,2,100,36,36,"assert(!(futex.wait[_pid]))", 1, 2, 0); /* m: 78 -> 0,100 */
	reached0[78] = 1;
	...
	T = T->nxt	= settr(99,2,79,0,0,"DO", 1, 2, 0);
	    T->nxt	= settr(99,2,81,0,0,"DO", 1, 2, 0);
	trans[0][79]	= settr(78,0,114,37,37,"(((num_woken==1)||(futex.num_waiting==0)))", 1, 2, 0); /* m: 103 -> 114,0 */
	reached0[103] = 1;
	trans[0][80]	= settr(79,2,103,1,0,"goto :b2", 1, 2, 0); /* m: 103 -> 0,114 */
	reached0[103] = 1;
	trans[0][81]	= settr(80,2,96,2,0,"else", 1, 2, 0);
	...
	trans[0][82]	= settr(81,2,100,38,38,"(futex.wait[1])", 1, 2, 0); /* m: 83 -> 100,0 */
	reached0[83] = 1;
	trans[0][83]	= settr(0,0,0,0,0,"futex.wait[1] = 0",0,0,0);
	trans[0][97]	= settr(96,2,98,1,0,".(goto)", 1, 2, 0); /* m: 98 -> 0,100 */
	reached0[98] = 1;
	trans[0][84]	= settr(83,2,100,39,39,"(futex.wait[2])", 1, 2, 0); /* m: 85 -> 100,0 */
	reached0[85] = 1;
	trans[0][85]	= settr(0,0,0,0,0,"futex.wait[2] = 0",0,0,0);
	trans[0][86]	= settr(85,2,100,40,40,"(futex.wait[3])", 1, 2, 0); /* m: 87 -> 100,0 */
	reached0[87] = 1;
	trans[0][87]	= settr(0,0,0,0,0,"futex.wait[3] = 0",0,0,0);
	trans[0][88]	= settr(87,2,100,41,41,"(futex.wait[4])", 1, 2, 0); /* m: 89 -> 100,0 */
	reached0[89] = 1;
	trans[0][89]	= settr(0,0,0,0,0,"futex.wait[4] = 0",0,0,0);
	trans[0][90]	= settr(89,2,100,42,42,"(futex.wait[5])", 1, 2, 0); /* m: 91 -> 100,0 */
	reached0[91] = 1;
	trans[0][91]	= settr(0,0,0,0,0,"futex.wait[5] = 0",0,0,0);
	trans[0][92]	= settr(91,2,100,43,43,"(futex.wait[6])", 1, 2, 0); /* m: 93 -> 100,0 */
	reached0[93] = 1;
	trans[0][93]	= settr(0,0,0,0,0,"futex.wait[6] = 0",0,0,0);
	trans[0][94]	= settr(93,2,100,44,44,"(futex.wait[7])", 1, 2, 0); /* m: 95 -> 100,0 */
	reached0[95] = 1;
	trans[0][95]	= settr(0,0,0,0,0,"futex.wait[7] = 0",0,0,0);
	trans[0][98]	= settr(97,2,100,45,45,"futex.num_waiting = (futex.num_waiting-1)", 1, 2, 0); /* m: 99 -> 0,100 */
	reached0[99] = 1;
	trans[0][99]	= settr(0,0,0,0,0,"num_woken = (num_woken+1)",0,0,0);
	trans[0][102]	= settr(101,2,103,1,0,"break", 1, 2, 0);
	trans[0][103]	= settr(102,0,114,46,46,"printf('T%d woke up %d thread(s)\\n',_pid,num_woken)", 1, 2, 0); /* m: 104 -> 0,114 */
	reached0[104] = 1;
	trans[0][104]	= settr(0,0,0,0,0,"num_woken = 0",0,0,0);
	trans[0][109]	= settr(108,0,110,1,0,".(goto)", 0, 2, 0); /* m: 110 -> 0,114 */
	reached0[110] = 1;
	trans[0][107]	= settr(106,0,110,2,0,"else", 0, 2, 0);
	trans[0][110]	= settr(109,0,114,47,47,"prev = 0", 0, 2, 0);
	trans[0][112]	= settr(111,0,117,48,0,"printf('T%d is done\\n',_pid)", 0, 2, 0);
	trans[0][113]	= settr(112,0,117,1,0,"goto :b0", 0, 2, 0);
	trans[0][116]	= settr(115,0,117,1,0,"break", 0, 2, 0);
	trans[0][117]	= settr(116,0,0,49,49,"-end-", 0, 3500, 0);
	/* np_ demon: */
