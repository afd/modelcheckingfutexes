...
{	Trans *T;
	...
	trans[2][8]	= settr(128,0,10,4,4,"(run Monitor())", 0, 2, 0);
	trans[2][10]	= settr(130,0,0,5,5,"-end-", 0, 3500, 0);
...
/*->*/	trans[0][75]	= settr(74,32,108,26,26,"D_STEP", 1, 2, 0);
	...
	trans[0][77]	= settr(76,2,100,28,28,"assert(!(futex.wait[_pid]))", 1, 2, 0); /* m: 78 -> 0,100 */
	reached0[78] = 1;
	...
	trans[0][79]	= settr(78,0,114,29,29,"(((num_woken==1)||(futex.num_waiting==0)))", 1, 2, 0); /* m: 103 -> 114,0 */
	reached0[103] = 1;
	...
	trans[0][82]	= settr(81,2,100,30,30,"(futex.wait[1])", 1, 2, 0); /* m: 83 -> 100,0 */
	reached0[83] = 1;
	trans[0][83]	= settr(0,0,0,0,0,"futex.wait[1] = 0",0,0,0);
	trans[0][97]	= settr(96,2,98,1,0,".(goto)", 1, 2, 0); /* m: 98 -> 0,100 */
	reached0[98] = 1;
	trans[0][84]	= settr(83,2,100,31,31,"(futex.wait[2])", 1, 2, 0); /* m: 85 -> 100,0 */
	reached0[85] = 1;
	trans[0][85]	= settr(0,0,0,0,0,"futex.wait[2] = 0",0,0,0);
	trans[0][86]	= settr(85,2,100,32,32,"(futex.wait[3])", 1, 2, 0); /* m: 87 -> 100,0 */
	reached0[87] = 1;
	trans[0][87]	= settr(0,0,0,0,0,"futex.wait[3] = 0",0,0,0);
	trans[0][88]	= settr(87,2,100,33,33,"(futex.wait[4])", 1, 2, 0); /* m: 89 -> 100,0 */
	reached0[89] = 1;
	trans[0][89]	= settr(0,0,0,0,0,"futex.wait[4] = 0",0,0,0);
	trans[0][90]	= settr(89,2,100,34,34,"(futex.wait[5])", 1, 2, 0); /* m: 91 -> 100,0 */
	reached0[91] = 1;
	trans[0][91]	= settr(0,0,0,0,0,"futex.wait[5] = 0",0,0,0);
	trans[0][92]	= settr(91,2,100,35,35,"(futex.wait[6])", 1, 2, 0); /* m: 93 -> 100,0 */
	reached0[93] = 1;
	trans[0][93]	= settr(0,0,0,0,0,"futex.wait[6] = 0",0,0,0);
	trans[0][94]	= settr(93,2,100,36,36,"(futex.wait[7])", 1, 2, 0); /* m: 95 -> 100,0 */
	reached0[95] = 1;
	trans[0][95]	= settr(0,0,0,0,0,"futex.wait[7] = 0",0,0,0);
	trans[0][98]	= settr(97,2,100,37,37,"futex.num_waiting = (futex.num_waiting-1)", 1, 2, 0); /* m: 99 -> 0,100 */
	reached0[99] = 1;
	trans[0][99]	= settr(0,0,0,0,0,"num_woken = (num_woken+1)",0,0,0);
	trans[0][102]	= settr(101,2,103,1,0,"break", 1, 2, 0);
	trans[0][103]	= settr(102,0,114,38,38,"printf('T%d woke up %d thread(s)\\n',_pid,num_woken)", 1, 2, 0); /* m: 104 -> 0,114 */
	reached0[104] = 1;
	...
	trans[0][110]	= settr(109,0,114,39,39,"prev = 0", 0, 2, 0);
	trans[0][112]	= settr(111,0,117,40,0,"printf('T%d is done\\n',_pid)", 0, 2, 0);
	trans[0][113]	= settr(112,0,117,1,0,"goto :b0", 0, 2, 0);
	trans[0][116]	= settr(115,0,117,1,0,"break", 0, 2, 0);
	trans[0][117]	= settr(116,0,0,41,41,"-end-", 0, 3500, 0);
	/* np_ demon: */
