...
S_097_0: /* 1 */
	...
	case 27: /* STATE 76 - line 73 "../../../gustedt_mutex1.pml" - [((prev!=((1<<7)|1)))] (0:0:1 - 1) */
		...
		if (!readtrail)
			...
			((P0 *)this)->prev = 0;
		_m = 3; goto P999; /* 0 */
	case 28: /* STATE 77 - line 70 "../../../futex.pml" - [assert(!(futex.wait[_pid]))] (0:90:1 - 1) */
		IfNotBlocked
		reached[0][77] = 1;
		assert( !(((int)now.futex.wait[ Index(((int)((P0 *)this)->_pid), 4) ])), " !(futex.wait[_pid])", II, tt, t);
		...
		;
		_m = 3; goto P999; /* 2 */
	case 29: /* STATE 79 - line 74 "../../../futex.pml" - [(((num_woken==1)||(futex.num_waiting==0)))] (104:0:2 - 1) */
		IfNotBlocked
		reached[0][79] = 1;
		...
		;
		_m = 3; goto P999; /* 6 */
	case 30: /* STATE 82 - line 78 "../../../futex.pml" - [(futex.wait[1])] (90:0:3 - 1) */
		IfNotBlocked
		reached[0][82] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 31: /* STATE 84 - line 80 "../../../futex.pml" - [(futex.wait[2])] (90:0:3 - 1) */
		IfNotBlocked
		reached[0][84] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 32: /* STATE 88 - line 82 "../../../futex.pml" - [futex.num_waiting = (futex.num_waiting-1)] (0:90:2 - 3) */
		IfNotBlocked
		reached[0][88] = 1;
		(trpt+1)->bup.ovals = grab_ints(2);
		...
		;
		_m = 3; goto P999; /* 2 */
	case 33: /* STATE 93 - line 85 "../../../futex.pml" - [printf('T%d woke up %d thread(s)\\n',_pid,num_woken)] (0:104:2 - 3) */
		IfNotBlocked
		reached[0][93] = 1;
		Printf("T%d woke up %d thread(s)\n", ((int)((P0 *)this)->_pid), ((int)((P0 *)this)->num_woken));
		/* merge: num_woken = 0(104, 94, 104) */
		...
		;
		_m = 3; goto P999; /* 4 */
	case 34: /* STATE 100 - line 76 "../../../gustedt_mutex1.pml" - [prev = 0] (0:104:1 - 3) */
		IfNotBlocked
		reached[0][100] = 1;
		...
		;
		_m = 3; goto P999; /* 1 */
	case 35: /* STATE 102 - line 22 "../../../mutex_generic.pml" - [printf('T%d is done\\n',_pid)] (0:0:0 - 1) */
		IfNotBlocked
		reached[0][102] = 1;
		Printf("T%d is done\n", ((int)((P0 *)this)->_pid));
		_m = 3; goto P999; /* 0 */
	case 36: /* STATE 107 - line 24 "../../../mutex_generic.pml" - [-end-] (0:0:0 - 3) */
		IfNotBlocked
		reached[0][107] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
