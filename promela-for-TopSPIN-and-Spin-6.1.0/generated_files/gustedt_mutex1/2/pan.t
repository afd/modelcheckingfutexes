...
{	Trans *T;
	...
	trans[2][3]	= settr(113,0,5,4,4,"(run Monitor())", 0, 2, 0);
	trans[2][5]	= settr(115,0,0,5,5,"-end-", 0, 3500, 0);
...
/*->*/	trans[0][75]	= settr(74,32,98,26,26,"D_STEP", 1, 2, 0);
	...
	trans[0][77]	= settr(76,2,90,28,28,"assert(!(futex.wait[_pid]))", 1, 2, 0); /* m: 78 -> 0,90 */
	reached0[78] = 1;
	...
	trans[0][79]	= settr(78,0,104,29,29,"(((num_woken==1)||(futex.num_waiting==0)))", 1, 2, 0); /* m: 93 -> 104,0 */
	reached0[93] = 1;
	...
	trans[0][100]	= settr(99,0,104,34,34,"prev = 0", 0, 2, 0);
	trans[0][102]	= settr(101,0,107,35,0,"printf('T%d is done\\n',_pid)", 0, 2, 0);
	trans[0][103]	= settr(102,0,107,1,0,"goto :b0", 0, 2, 0);
	trans[0][106]	= settr(105,0,107,1,0,"break", 0, 2, 0);
	trans[0][107]	= settr(106,0,0,36,36,"-end-", 0, 3500, 0);
	/* np_ demon: */
