...
S_009_0: /* 1 */
	...
	case 16: /* STATE 5 - ../../../gustedt_mutex1.pml:24 - [((cur==0))] (64:0:1 - 1) */
		IfNotBlocked
		reached[0][5] = 1;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 17: /* STATE 11 - ../../../gustedt_mutex1.pml:31 - [.(goto)] (0:21:0 - 1) */
		IfNotBlocked
		reached[0][11] = 1;
		;
		_m = 3; goto P999; /* 0 */
	case 18: /* STATE 9 - ../../../gustedt_mutex1.pml:28 - [printf('T%d fails to lock mutex on fast path\\n',_pid)] (0:21:0 - 1) */
		IfNotBlocked
		reached[0][9] = 1;
		...
		;
		_m = 3; goto P999; /* 1 */
	case 19: /* STATE 20 - ../../../lockbit.pml:8 - [D_STEP] */
		IfNotBlocked
		sv_save();
		reached[0][20] = 1;
		reached[0][t->st] = 1;
...
S_021_0: /* 1 */
	...
	case 20: /* STATE 22 - ../../../gustedt_mutex1.pml:33 - [cur = (cur+1)] (0:62:1 - 1) */
		IfNotBlocked
		reached[0][22] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 21: /* STATE 23 - ../../../gustedt_mutex1.pml:37 - [((((1<<7)&cur)==0))] (0:0:0 - 1) */
		IfNotBlocked
		reached[0][23] = 1;
		if (!((((1<<7)&((int)((P0 *)this)->_2_cur))==0)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 22: /* STATE 26 - ../../../atomics.pml:3 - [D_STEP] */
		IfNotBlocked
		sv_save();
		reached[0][26] = 1;
		reached[0][t->st] = 1;
...
S_031_0: /* 1 */
	...
	case 23: /* STATE 28 - ../../../gustedt_mutex1.pml:41 - [((cur==tmp))] (64:0:2 - 1) */
		IfNotBlocked
		reached[0][28] = 1;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 24: /* STATE 35 - ../../../gustedt_mutex1.pml:47 - [cur = futex.word] (0:0:1 - 1) */
		IfNotBlocked
		reached[0][35] = 1;
		(trpt+1)->bup.oval = ((int)((P0 *)this)->_2_cur);
		((P0 *)this)->_2_cur = ((int)now.futex.word);
		...
		;
		_m = 3; goto P999; /* 0 */
	case 25: /* STATE 36 - ../../../gustedt_mutex1.pml:49 - [(((1<<7)&cur))] (0:0:1 - 1) */
		IfNotBlocked
		reached[0][36] = 1;
		...
		if (!readtrail)
			...
			((P0 *)this)->_2_cur = 0;
		_m = 3; goto P999; /* 0 */
	case 26: /* STATE 37 - ../../../gustedt_mutex1.pml:49 - [cur = futex.word] (0:0:1 - 1) */
		IfNotBlocked
		reached[0][37] = 1;
		(trpt+1)->bup.oval = ((int)((P0 *)this)->_2_cur);
		((P0 *)this)->_2_cur = ((int)now.futex.word);
...
S_054_0: /* 2 */
	...
	case 30: /* STATE 60 - ../../../gustedt_mutex1.pml:55 - [cur = futex.word] (0:0:1 - 3) */
		IfNotBlocked
		reached[0][60] = 1;
		(trpt+1)->bup.oval = ((int)((P0 *)this)->_2_cur);
		((P0 *)this)->_2_cur = ((int)now.futex.word);
		...
		;
		_m = 3; goto P999; /* 0 */
	case 31: /* STATE 64 - ../../../gustedt_mutex1.pml:59 - [tmp = 0] (0:0:1 - 3) */
		IfNotBlocked
		reached[0][64] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 32: /* STATE 65 - ../../../gustedt_mutex1.pml:59 - [cur = 0] (0:0:1 - 1) */
		IfNotBlocked
		reached[0][65] = 1;
		(trpt+1)->bup.oval = ((int)((P0 *)this)->_2_cur);
		((P0 *)this)->_2_cur = 0;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 33: /* STATE 67 - ../../../mutex_generic.pml:26 - [num_threads_in_cs = (num_threads_in_cs+1)] (0:0:1 - 1) */
		IfNotBlocked
		reached[0][67] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 34: /* STATE 68 - ../../../mutex_generic.pml:27 - [num_threads_in_cs = (num_threads_in_cs-1)] (0:0:1 - 1) */
		IfNotBlocked
		reached[0][68] = 1;
		(trpt+1)->bup.oval = ((int)now.num_threads_in_cs);
		now.num_threads_in_cs = (((int)now.num_threads_in_cs)-1);
		...
		;
		_m = 3; goto P999; /* 0 */
	case 35: /* STATE 75 - ../../../gustedt_mutex1.pml:63 - [D_STEP] */
		IfNotBlocked
		sv_save();
		reached[0][75] = 1;
		reached[0][t->st] = 1;
...
S_109_0: /* 1 */
	...
	case 36: /* STATE 76 - ../../../gustedt_mutex1.pml:70 - [((prev!=((1<<7)|1)))] (0:0:1 - 1) */
		IfNotBlocked
		reached[0][76] = 1;
		...
		if (!readtrail)
			...
			((P0 *)this)->_2_prev = 0;
		_m = 3; goto P999; /* 0 */
	case 37: /* STATE 77 - ../../../futex.pml:70 - [assert(!(futex.wait[_pid]))] (0:102:1 - 1) */
		IfNotBlocked
		reached[0][77] = 1;
		spin_assert( !(((int)now.futex.wait[ Index(((int)((P0 *)this)->_pid), 10) ])), " !(futex.wait[_pid])", II, tt, t);
		...
		;
		_m = 3; goto P999; /* 2 */
	case 38: /* STATE 79 - ../../../futex.pml:74 - [(((num_woken==1)||(futex.num_waiting==0)))] (116:0:2 - 1) */
		IfNotBlocked
		reached[0][79] = 1;
		...
		;
		_m = 3; goto P999; /* 6 */
	case 39: /* STATE 82 - ../../../futex.pml:78 - [(futex.wait[1])] (102:0:3 - 1) */
		IfNotBlocked
		reached[0][82] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 40: /* STATE 84 - ../../../futex.pml:80 - [(futex.wait[2])] (102:0:3 - 1) */
		IfNotBlocked
		reached[0][84] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 41: /* STATE 86 - ../../../futex.pml:83 - [(futex.wait[3])] (102:0:3 - 1) */
		IfNotBlocked
		reached[0][86] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 42: /* STATE 88 - ../../../futex.pml:87 - [(futex.wait[4])] (102:0:3 - 1) */
		IfNotBlocked
		reached[0][88] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 43: /* STATE 90 - ../../../futex.pml:91 - [(futex.wait[5])] (102:0:3 - 1) */
		IfNotBlocked
		reached[0][90] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 44: /* STATE 92 - ../../../futex.pml:95 - [(futex.wait[6])] (102:0:3 - 1) */
		IfNotBlocked
		reached[0][92] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 45: /* STATE 94 - ../../../futex.pml:99 - [(futex.wait[7])] (102:0:3 - 1) */
		IfNotBlocked
		reached[0][94] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 46: /* STATE 96 - ../../../futex.pml:103 - [(futex.wait[8])] (102:0:3 - 1) */
		IfNotBlocked
		reached[0][96] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 47: /* STATE 100 - ../../../futex.pml:105 - [futex.num_waiting = (futex.num_waiting-1)] (0:102:2 - 9) */
		IfNotBlocked
		reached[0][100] = 1;
		(trpt+1)->bup.ovals = grab_ints(2);
		...
		;
		_m = 3; goto P999; /* 2 */
	case 48: /* STATE 105 - ../../../futex.pml:108 - [printf('T%d woke up %d thread(s)\\n',_pid,num_woken)] (0:116:2 - 3) */
		IfNotBlocked
		reached[0][105] = 1;
		Printf("T%d woke up %d thread(s)\n", ((int)((P0 *)this)->_pid), ((int)((P0 *)this)->_2_num_woken));
		/* merge: num_woken = 0(116, 106, 116) */
		...
		;
		_m = 3; goto P999; /* 4 */
	case 49: /* STATE 112 - ../../../gustedt_mutex1.pml:73 - [prev = 0] (0:116:1 - 3) */
		IfNotBlocked
		reached[0][112] = 1;
		...
		;
		_m = 3; goto P999; /* 1 */
	case 50: /* STATE 114 - ../../../mutex_generic.pml:29 - [printf('T%d is done\\n',_pid)] (0:0:0 - 1) */
		IfNotBlocked
		reached[0][114] = 1;
		Printf("T%d is done\n", ((int)((P0 *)this)->_pid));
		_m = 3; goto P999; /* 0 */
	case 51: /* STATE 119 - ../../../mutex_generic.pml:31 - [-end-] (0:0:0 - 3) */
		IfNotBlocked
		reached[0][119] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
