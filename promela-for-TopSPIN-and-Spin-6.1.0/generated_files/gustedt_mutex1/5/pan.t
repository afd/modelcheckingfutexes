...
{	Trans *T;
	...
	trans[2][6]	= settr(122,0,8,4,4,"(run Monitor())", 0, 2, 0);
	trans[2][8]	= settr(124,0,0,5,5,"-end-", 0, 3500, 0);
...
/*->*/	trans[0][75]	= settr(74,32,104,26,26,"D_STEP", 1, 2, 0);
	...
	trans[0][77]	= settr(76,2,96,28,28,"assert(!(futex.wait[_pid]))", 1, 2, 0); /* m: 78 -> 0,96 */
	reached0[78] = 1;
	...
	trans[0][79]	= settr(78,0,110,29,29,"(((num_woken==1)||(futex.num_waiting==0)))", 1, 2, 0); /* m: 99 -> 110,0 */
	reached0[99] = 1;
	...
	trans[0][82]	= settr(81,2,96,30,30,"(futex.wait[1])", 1, 2, 0); /* m: 83 -> 96,0 */
	reached0[83] = 1;
	trans[0][83]	= settr(0,0,0,0,0,"futex.wait[1] = 0",0,0,0);
	trans[0][93]	= settr(92,2,94,1,0,".(goto)", 1, 2, 0); /* m: 94 -> 0,96 */
	reached0[94] = 1;
	trans[0][84]	= settr(83,2,96,31,31,"(futex.wait[2])", 1, 2, 0); /* m: 85 -> 96,0 */
	reached0[85] = 1;
	trans[0][85]	= settr(0,0,0,0,0,"futex.wait[2] = 0",0,0,0);
	trans[0][86]	= settr(85,2,96,32,32,"(futex.wait[3])", 1, 2, 0); /* m: 87 -> 96,0 */
	reached0[87] = 1;
	trans[0][87]	= settr(0,0,0,0,0,"futex.wait[3] = 0",0,0,0);
	trans[0][88]	= settr(87,2,96,33,33,"(futex.wait[4])", 1, 2, 0); /* m: 89 -> 96,0 */
	reached0[89] = 1;
	trans[0][89]	= settr(0,0,0,0,0,"futex.wait[4] = 0",0,0,0);
	trans[0][90]	= settr(89,2,96,34,34,"(futex.wait[5])", 1, 2, 0); /* m: 91 -> 96,0 */
	reached0[91] = 1;
	trans[0][91]	= settr(0,0,0,0,0,"futex.wait[5] = 0",0,0,0);
	trans[0][94]	= settr(93,2,96,35,35,"futex.num_waiting = (futex.num_waiting-1)", 1, 2, 0); /* m: 95 -> 0,96 */
	reached0[95] = 1;
	trans[0][95]	= settr(0,0,0,0,0,"num_woken = (num_woken+1)",0,0,0);
	trans[0][98]	= settr(97,2,99,1,0,"break", 1, 2, 0);
	trans[0][99]	= settr(98,0,110,36,36,"printf('T%d woke up %d thread(s)\\n',_pid,num_woken)", 1, 2, 0); /* m: 100 -> 0,110 */
	reached0[100] = 1;
	...
	trans[0][106]	= settr(105,0,110,37,37,"prev = 0", 0, 2, 0);
	trans[0][108]	= settr(107,0,113,38,0,"printf('T%d is done\\n',_pid)", 0, 2, 0);
	trans[0][109]	= settr(108,0,113,1,0,"goto :b0", 0, 2, 0);
	trans[0][112]	= settr(111,0,113,1,0,"break", 0, 2, 0);
	trans[0][113]	= settr(112,0,0,39,39,"-end-", 0, 3500, 0);
	/* np_ demon: */
