...
{	Trans *T;
	...
	T = trans[ 2][5] = settr(117,2,0,0,0,"ATOMIC", 0, 2, 0);
	T->nxt	= settr(117,2,1,0,0,"ATOMIC", 0, 2, 0);
	...
	trans[2][4]	= settr(116,0,6,6,6,"(run Monitor())", 0, 2, 0);
	trans[2][6]	= settr(118,0,0,7,7,"-end-", 0, 3500, 0);
	...
	trans[1][1]	= settr(109,4,4,8,8,"((num_threads_in_cs>1))", 1, 2, 0); /* m: 2 -> 4,0 */
	reached1[2] = 1;
	trans[1][2]	= settr(0,0,0,0,0,"assert(0)",0,0,0);
	trans[1][4]	= settr(112,0,0,9,9,"-end-", 0, 3500, 0);
	...
	T = T->nxt	= settr(105,0,66,0,0,"DO", 0, 2, 0);
...
/*->*/	trans[0][26]	= settr(25,34,32,17,17,"D_STEP", 1, 2, 0);
	...
	trans[0][35]	= settr(34,0,40,19,19,"cur = futex.word", 1, 2, 0);
	...
	trans[0][36]	= settr(35,0,37,20,20,"(((1<<7)&cur))", 0, 2, 0);
	trans[0][37]	= settr(36,0,40,21,21,"cur = futex.word", 1, 2, 0);
...
/*->*/	trans[0][56]	= settr(55,32,60,24,24,"D_STEP", 1, 2, 0);
	trans[0][60]	= settr(59,0,62,25,25,"cur = futex.word", 1, 2, 0);
	trans[0][61]	= settr(60,0,62,1,0,"goto retry", 0, 2, 0);
	trans[0][64]	= settr(63,0,65,26,26,"tmp = 0", 0, 2, 0);
	trans[0][65]	= settr(64,0,67,27,27,"cur = 0", 0, 2, 0);
	trans[0][67]	= settr(66,0,68,28,28,"num_threads_in_cs = (num_threads_in_cs+1)", 1, 2, 0);
	trans[0][68]	= settr(67,0,103,29,29,"num_threads_in_cs = (num_threads_in_cs-1)", 1, 2, 0);
	T = trans[ 0][103] = settr(102,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(102,0,75,0,0,"sub-sequence", 0, 2, 0);
/*->*/	trans[0][75]	= settr(74,32,100,30,30,"D_STEP", 1, 2, 0);
	T = trans[0][100] = settr(99,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(99,0,76,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(99,0,99,0,0,"IF", 0, 2, 0);
	trans[0][76]	= settr(75,0,98,31,31,"((prev!=((1<<7)|1)))", 0, 2, 0);
	...
	T->nxt	= settr(96,2,77,0,0,"ATOMIC", 1, 2, 0);
	trans[0][77]	= settr(76,2,92,32,32,"assert(!(futex.wait[_pid]))", 1, 2, 0); /* m: 78 -> 0,92 */
	reached0[78] = 1;
	...
	T = T->nxt	= settr(91,2,79,0,0,"DO", 1, 2, 0);
	    T->nxt	= settr(91,2,81,0,0,"DO", 1, 2, 0);
	trans[0][79]	= settr(78,0,106,33,33,"(((num_woken==1)||(futex.num_waiting==0)))", 1, 2, 0); /* m: 95 -> 106,0 */
	reached0[95] = 1;
	trans[0][80]	= settr(79,2,95,1,0,"goto :b2", 1, 2, 0); /* m: 95 -> 0,106 */
	reached0[95] = 1;
	trans[0][81]	= settr(80,2,88,2,0,"else", 1, 2, 0);
	...
	trans[0][82]	= settr(81,2,92,34,34,"(futex.wait[1])", 1, 2, 0); /* m: 83 -> 92,0 */
	reached0[83] = 1;
	trans[0][83]	= settr(0,0,0,0,0,"futex.wait[1] = 0",0,0,0);
	trans[0][89]	= settr(88,2,90,1,0,".(goto)", 1, 2, 0); /* m: 90 -> 0,92 */
	reached0[90] = 1;
	trans[0][84]	= settr(83,2,92,35,35,"(futex.wait[2])", 1, 2, 0); /* m: 85 -> 92,0 */
	reached0[85] = 1;
	trans[0][85]	= settr(0,0,0,0,0,"futex.wait[2] = 0",0,0,0);
	trans[0][86]	= settr(85,2,92,36,36,"(futex.wait[3])", 1, 2, 0); /* m: 87 -> 92,0 */
	reached0[87] = 1;
	trans[0][87]	= settr(0,0,0,0,0,"futex.wait[3] = 0",0,0,0);
	trans[0][90]	= settr(89,2,92,37,37,"futex.num_waiting = (futex.num_waiting-1)", 1, 2, 0); /* m: 91 -> 0,92 */
	reached0[91] = 1;
	trans[0][91]	= settr(0,0,0,0,0,"num_woken = (num_woken+1)",0,0,0);
	trans[0][94]	= settr(93,2,95,1,0,"break", 1, 2, 0);
	trans[0][95]	= settr(94,0,106,38,38,"printf('T%d woke up %d thread(s)\\n',_pid,num_woken)", 1, 2, 0); /* m: 96 -> 0,106 */
	reached0[96] = 1;
	trans[0][96]	= settr(0,0,0,0,0,"num_woken = 0",0,0,0);
	trans[0][101]	= settr(100,0,102,1,0,".(goto)", 0, 2, 0); /* m: 102 -> 0,106 */
	reached0[102] = 1;
	trans[0][99]	= settr(98,0,102,2,0,"else", 0, 2, 0);
	trans[0][102]	= settr(101,0,106,39,39,"prev = 0", 0, 2, 0);
	trans[0][104]	= settr(103,0,109,40,0,"printf('T%d is done\\n',_pid)", 0, 2, 0);
	trans[0][105]	= settr(104,0,109,1,0,"goto :b0", 0, 2, 0);
	trans[0][108]	= settr(107,0,109,1,0,"break", 0, 2, 0);
	trans[0][109]	= settr(108,0,0,41,41,"-end-", 0, 3500, 0);
	/* np_ demon: */
